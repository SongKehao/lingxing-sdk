! function () {
  ...
  var h = !0,
    p = h && document.body.clientWidth <= 600,
    d = h && window.history && window.history.pushState && window.history.replaceState && !navigator.userAgent.match(/((iPod|iPhone|iPad).+\bOS\s+[1-4]\D|WebApps\/.+CFNetwork)/),
    g = {};
  ...
  function S(e, t, n) {
    a(t) ? window.addEventListener(e, t) : e.addEventListener(t, n)
  }

  function L(e, t, n) {
    a(t) ? window.removeEventListener(e, t) : e.removeEventListener(t, n)
  }
  ...
  function $(e, t) {
    return void 0 === t && (t = ""), e && e.length ? (e.forEach(function (e) {
      t += '<li><a class="section-link" href="' + e.slug + '">' + e.title + "</a></li>", e.children && (t += '<li><ul class="children">' + $(e.children) + "</li></ul>")
    }), t) : ""
  }
  ...
  function O(e) {
    ...
    !T && function () {
      var e = w("div");
      e.classList.add("progress"), x(v, e), T = e
    }(), t = i ? (t = parseInt(T.style.width || 0, 10) + i) > 80 ? 80 : t : Math.floor(n / r * 100), T.style.opacity = 1, T.style.width = t >= 95 ? "100%" : t + "%", t >= 95 && (clearTimeout(P), P = setTimeout(function (e) {
      T.style.opacity = 0, T.style.width = "0%"
    }, 200))
  }
  var F = {};
    ...
    return r.send(), {
      then: function (n, o) {
        if (void 0 === o && (o = i), t) {
          ...
          a("progress", O), a("loadend", function (e) {
            O(e), clearInterval(s)
          })
        }
        a("error", o), a("load", function (t) {
          var i = t.target;
          if (i.status >= 400) o(i);
          else {
            var a = F[e] = {
                      ...
                      for (var y = i, k = a; y < t.length; k += t[y].length, ++y) {
                        ...
                        if (!(w instanceof l)) {
                          ...
                          if (!($ = p.exec(w)) && f && y != t.length - 1) {
                            if (p.lastIndex = k, !($ = p.exec(e))) break;
                            for (var _ = $.index + (g ? $[1].length : 0), S = $.index + $[0].length, L = y, C = k, E = t.length; L < E && (C < S || !t[L].type && !t[L - 1].greedy); ++L) _ >= (C += t[L].length) && (++y, k = C);
                            if (t[y] instanceof l || t[L - 1].greedy) continue;
                            x = L - y, w = e.slice(k, C), $.index -= k
                          }
                          if ($) {
                            g && (m = $[1].length);
                            ...
                            if (P.push(O), T && P.push(T), Array.prototype.splice.apply(t, P), 1 != x && r.matchGrammar(e, t, n, y, k, !0, c), o) break
                          } else if (o) break
                        }
                      }
                    }
  ...
  function W(e) {
    ...
    var t = e.trim().replace(/[A-Z]+/g, Y).replace(/<[^>\d]+>/g, "").replace(D, "").replace(/\s/g, "-").replace(/-+/g, "-").replace(/^(\d)/, "_$1"),
      n = U[t];
    return n = U.hasOwnProperty(t) ? n + 1 : 0, U[t] = n, n && (t = t + "-" + n), t
  }
  W.clear = function () {
    U = {}
  };
  ...
  function J(e, t) {
    void 0 === t && (t = []);
    var n = [];
    for (var r in e) t.indexOf(r) > -1 || n.push(e[r] ? (V(r) + "=" + V(e[r])).toLowerCase() : V(r));
  ...
  var oe = {
      markdown: function (e) {
        var t = this,
          n = "docsify-get-" + ie++;
        return M(e, !1).then(function (e) {
          document.getElementById(n).innerHTML = t.compile(e)
        }), '<div data-origin="' + e + '" id=' + n + "></div>"
      },
      iframe: function (e, t) {
        return '<iframe src="' + e + '" ' + (t || "width=100% height=400") + "></iframe>"
      },
      video: function (e, t) {
        return '<video src="' + e + '" ' + (t || "controls") + ">Not Support</video>"
      },
      audio: function (e, t) {
        return '<audio src="' + e + '" ' + (t || "controls") + ">Not Support</audio>"
      },
      code: function (e, t) {
        var n = this,
          r = "docsify-get-" + ie++,
          i = e.match(/\.(\w+)$/);
        return "md" === (i = t || i && i[1]) && (i = "markdown"), M(e, !1).then(function (e) {
          document.getElementById(r).innerHTML = n.compile("```" + i + "\n" + e.replace(/`/g, "@qm@") + "\n```\n").replace(/@qm@/g, "`")
        }), '<div data-origin="' + e + '" id=' + r + "></div>"
      }
    },
    se = function (t, r) {
      this.config = t, this.router = r, this.cacheTree = {}, this.toc = [], this.linkTarget = t.externalLinkTarget || "_blank", this.contentBase = r.getBasePath();
      var i, o = this._initRenderer(),
        s = t.markdown || {};
      a(s) ? i = s(z, o) : (z.setOptions(n(s, {
        renderer: n(o, s.renderer)
      })), i = z), this.compile = e(function (e) {
        var n = "";
        if (!e) return e;
        n = i(e), n = t.noEmoji ? n : (r = n, r.replace(/<(pre|template|code)[^>]*?>[\s\S]+?<\/(pre|template|code)>/g, function (e) {
          return e.replace(/:/g, "__colon__")
        }).replace(/:(\w+?):/gi, h && window.emojify || G).replace(/__colon__/g, ":"));
        var r;
        return W.clear(), n
      })
    };
  se.prototype.matchNotCompileLink = function (e) {
    ...
    a.heading = e.heading = function (e, t) {
      ...
      void 0 === t && (t = "");
      return '<pre v-pre data-lang="' + t + '"><code class="lang-' + t + '">' + B.highlight(e, B.languages[t] || B.languages.markup) + "</code></pre>"
    }, a.link = e.link = function (e, a, o) {
      void 0 === a && (a = "");
      var s = "",
        l = ae(a),
        c = l.str,
      ...
      if (a = c, u.include) {
        K(e) || (e = Q(r, e));
        var h;
        if (u.type && (h = oe[u.type])) return h.call(i, e, a);
        var p = "code";
        return /\.(md|markdown)/.test(e) ? p = "markdown" : /\.html?/.test(e) ? p = "iframe" : /\.(mp4|ogg)/.test(e) ? p = "video" : /\.mp3/.test(e) && (p = "audio"), oe[p].call(i, e, a)
      }
      return /:|(\/{2})/.test(e) || i.matchNotCompileLink(e) || u.ignore ? s += ' target="' + t + '"' : (e === i.config.homepage && (e = "README"), e = n.toURL(e, null, n.getCurrentPath())), u.target && (s += " target=" + u.target), u.disabled && (s += " disabled", e = "javascript:void(0)"), a && (s += ' title="' + a + '"'), '<a href="' + e + '"' + s + ">" + o + "</a>"
    }, a.paragraph = e.paragraph = function (e) {
      return /^!&gt;/.test(e) ? A("tip", e) : /^\?&gt;/.test(e) ? A("warn", e) : "<p>" + e + "</p>"
    }, a.image = e.image = function (e, t, n) {
      var i = e,
        a = "",
        o = ae(t);
      return t = o.str, o.config["no-zoom"] && (a += " data-no-zoom"), t && (a += ' title="' + t + '"'), K(e) || (i = Q(r, e)), '<img src="' + i + '"data-origin="' + e + '" alt="' + n + '"' + a + ">"
    };
    var o = /^\[([ x])\] +/;
    ...
    var n = this.router.getCurrentPath(),
      r = "";
    if (e) r = (r = this.compile(e)) && r.match(/<ul[^>]*>([\s\S]+)<\/ul>/g) && r.match(/<ul[^>]*>([\s\S]+)<\/ul>/g)[0];
    else {
      var i = this.cacheTree[n] || I(this.toc, t);
    ...
    if (e) {
      ...
      var a = n[t] || I(r, e);
      return n[t] = a, this.toc = [], $(a, '<ul class="app-sub-sidebar">')
    }
    this.toc = []
  ...
  function ce() {
    ...
    if (e) {
      ...
      window.pageYOffset >= t || e.classList.contains("hidden") ? C(v, "add", "sticky") : C(v, "remove", "sticky")
    }
  }
  ...
  function ue(e, t, n, r) {
    ...
    return a.sort(function (e, t) {
      ...
      var t = e.getAttribute("href"),
        r = n ? e.parentNode : e;
      0 !== o.indexOf(t) || i ? C(r, "remove", "active") : (i = e, C(r, "add", "active"))
    }), r && (m.title = i ? i.innerText + " - " + le : le), i
  }
  var he = function () {
    function e(e, t) {
  ...
  function be(e) {
    if (me) {
      for (var t, n = f(".sidebar"), r = k(".anchor"), i = y(n, ".sidebar-nav"), a = y(n, "li.active"), o = document.documentElement, s = (o && o.scrollTop || document.body.scrollTop) - ve, l = 0, c = r.length; l < c; l += 1) {
        var u = r[l];
        if (u.offsetTop > s) {
          t || (t = u);
          break
      ...
      if (t) {
        var h = de[ye(e, t.getAttribute("data-id"))];
        if (h && h !== a && (a && a.classList.remove("active"), h.classList.add("active"), a = h, !ge && v.classList.contains("sticky"))) {
          var p = n.clientHeight,
            d = a.offsetTop + a.clientHeight + 40,
            g = d - 0 < p,
            m = a.offsetTop >= i.scrollTop && d <= i.scrollTop + p ? i.scrollTop : g ? 0 : d - p;
          // n.scrollTop = m
        }
      }
    }
  ...
  function ke(e, t) {
    if (t) {
      var n = y("#" + t);
      n && (r = n, fe && fe.stop(), me = !1, fe = new pe({
      ...
      var r, i = de[ye(e, t)],
        a = y(f(".sidebar"), "li.active");
      a && a.classList.remove("active"), i && i.classList.add("active")
    }
  }
  var we = m.scrollingElement || m.documentElement;
  ...
  function _e(e, t, n) {
    return t = "function" == typeof n ? n(t) : "string" == typeof n ? function (e) {
      var t = [],
        n = 0;
      return e.replace(q, function (r, i, a) {
          t.push(e.substring(n, a - 1)), n = a += r.length + 1, t.push(function (e) {
            return ("00" + ("string" == typeof N[r] ? e[N[r]]() : N[r](e))).slice(-r.length)
          })
  ...
  function Se(e) {
    e || (e = "not found"), this._renderTo(".markdown-section", e), !this.config.loadSidebar && this._renderSidebar(), !1 === this.config.executeScript || void 0 === window.Vue || xe() ? this.config.executeScript && xe() : setTimeout(function (e) {
  ...
  function Le(e) {
    ...
    i ? (t.repo && (a += (s = t.repo, s ? (/\/\//.test(s) || (s = "https://github.com/" + s), '<a href="' + (s = s.replace(/^git\+/, "")) + '" class="github-corner" aria-label="View source on Github"><svg viewBox="0 0 250 250" aria-hidden="true"><path d="M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z"></path><path d="M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6 C119.2,72.0 123.4,76.3 123.4,76.3 C127.3,80.9 125.5,87.3 125.5,87.3 C122.9,97.6 130.6,101.9 134.4,103.2" fill="currentColor" style="transform-origin: 130px 106px;" class="octo-arm"></path><path d="M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2 139.9,98.4 142.2,98.6 C133.8,88.0 127.5,74.4 143.8,58.0 C148.5,53.4 154.0,51.2 159.7,51.0 C160.3,49.4 163.2,43.6 171.4,40.1 C171.4,40.1 176.1,42.5 178.8,56.2 C183.1,58.6 187.2,61.8 190.9,65.4 C194.5,69.0 197.7,73.2 200.1,77.6 C213.8,80.2 216.3,84.9 216.3,84.9 C212.7,93.1 206.9,96.0 205.4,96.6 C205.1,102.4 203.0,107.8 198.3,112.5 C181.9,128.9 168.3,122.5 157.7,114.1 C157.9,116.9 156.7,120.9 152.7,124.9 L141.0,136.5 C139.8,137.7 141.6,141.9 141.8,141.8 Z" fill="currentColor" class="octo-body"></path></svg></a>') : "")), t.coverpage && (a += '<section class="cover show" style="background: linear-gradient(to left bottom, hsl(' + Math.floor(255 * Math.random()) + ", 100%, 85%) 0%,hsl(" + Math.floor(255 * Math.random()) + ', 100%, 85%) 100%)"><div class="cover-main">\x3c!--cover--\x3e</div><div class="mask"></div></section>'), a += function (e) {
      ...
      return (p ? t + "<main>" : "<main>" + t) + '<section class="content"><article class="markdown-section" id="main">\x3c!--main--\x3e</article></section></main>'
    }(t), e._renderTo(i, a, !0)) : e.rendered = !0;
    var s;
    t.mergeNavbar && p ? o = y(".sidebar") : (r.classList.add("app-nav"), t.repo || r.classList.add("no-badge")), _(o, r), t.themeColor && (m.head.appendChild(w("div", (l = t.themeColor, "<style>:root{--theme-color: " + l + ";}</style>")).firstElementChild), function (e) {
      if (!(window.CSS && window.CSS.supports && window.CSS.supports("(--v:red)"))) {
        var t = k("style:not(.inserted),link");
        [].forEach.call(t, function (t) {
          if ("STYLE" === t.nodeName) j(t, e);
          else if ("LINK" === t.nodeName) {
            var n = t.getAttribute("href");
            if (!/\.css$/.test(n)) return;
            M(n).then(function (t) {
              var n = w("style", t);
              b.appendChild(n), j(n, e)
            })
          }
        })
      }
    ...
    var l;
    e._updateRender(), C(v, "ready")
  }
  var Ce = {};
  var Ee = function (e) {
    this.config = e
  };
  Ee.prototype.getBasePath = function () {
    return this.config.basePath
  }, Ee.prototype.getFile = function (e, t) {
    void 0 === e && (e = this.getCurrentPath());
    var n = this.config,
      r = this.getBasePath(),
      i = "string" != typeof n.ext ? ".md" : n.ext;
    e = n.alias ? function e(t, n, r) {
      var i = Object.keys(n).filter(function (e) {
        return (Ce[e] || (Ce[e] = new RegExp("^" + e + "$"))).test(t) && t !== r
      })[0];
      return i ? e(t.replace(Ce[i], n[i]), n, t) : t
    }(e, n.alias) : e, a = e, o = i;
    var a, o;
    return e = (e = new RegExp("\\.(" + o.replace(/^\./, "") + "|html)$", "g").test(a) ? a : /\/$/g.test(a) ? a + "README" + o : "" + a + o) === "/README" + i ? n.homepage || e : e, e = K(e) ? e : Q(r, e), t && (e = e.replace(new RegExp("^" + r), "")), e
  }, Ee.prototype.onchange = function (e) {
    void 0 === e && (e = i), e()
  }, Ee.prototype.getCurrentPath = function () {}, Ee.prototype.normalize = function () {}, Ee.prototype.parse = function () {}, Ee.prototype.toURL = function (e, t, r) {
    var i = r && "#" === e[0],
      a = this.parse(ne(e));
    if (a.query = n({}, a.query, t), e = (e = a.path + J(a.query)).replace(/\.md(\?)|\.md$/, "$1"), i) {
      var o = r.indexOf("?");
      e = (o > 0 ? r.substr(0, o) : r) + e
    }
    return te("/" + e)
  };
  ...
  var Ae = function (e) {
      ...
      return e && (t.__proto__ = e), t.prototype = Object.create(e && e.prototype), t.prototype.constructor = t, t.prototype.getBasePath = function () {
        ...
        void 0 === e && (e = i), S("hashchange", e)
      }, t.prototype.normalize = function () {
        var e = this.getCurrentPath();
        if ("/" === (e = ne(e)).charAt(0)) return $e(e);
        $e("/" + e)
  ...
  function Fe(e) {
    ! function (e, t) {
      ...
      S(e = f(e), "click", function (e) {
        e.stopPropagation(), n()
      }), p && S(v, "click", function (e) {
        return v.classList.contains("close") && n()
      })
    }("button.sidebar-toggle", e.router), t = ".sidebar", e.router, S(t = f(t), "click", function (e) {
      // console.log(document.getElementsByClassName('actives')[0].getElementsByTagName('a')[0])
      var t = e.target;
      // console.log(t.childNodes)
      // "A" === t.nodeName && t.nextSibling && t.nextSibling.classList.contains("app-sub-sidebar") && C(t.parentNode, "collapse")
    });
    var t;
    e.config.coverpage ? !p && S("scroll", ce) : v.classList.add("sticky")
  }

  function Me(e, t, n, r, i, a) {
    e = a ? e : e.replace(/\/$/, ""), (e = ee(e)) && M(i.router.getFile(e + n) + t, !1, i.config.requestHeaders).then(r, function (a) {
      return Me(e, t, n, r, i)
    })
  }
  ...
  Ne._init = function () {
    ...
    [].concat((t = this).config.plugins).forEach(function (e) {
      return a(e) && e(t._lifecycle, t)
    });
    var t;
    u(this, "init"),
      function (e) {
        var t, n = e.config;
        t = "history" === (n.routerMode || "hash") && d ? new Te(n) : new Ae(n), e.router = t, Oe(e), Pe = e.route, t.onchange(function (t) {
          Oe(e), e._updateRender(), Pe.path !== e.route.path ? (e.$fetch(), Pe = e.route) : e.$resetEvents()
        })
      }(this), Le(this), Fe(this),
      function (e) {
        var t = e.config.loadSidebar;
        if (e.rendered) {
          var n = ue(e.router, ".sidebar-nav", !0, !0);
  ...
  Ne.route = {};
  (Re = Ne)._renderTo = function (e, t, n) {
    var r = f(e);
    r && (r[n ? "outerHTML" : "innerHTML"] = t)
  }, Re._renderSidebar = function (e) {
    var t = this.config,
      n = t.maxLevel,
      r = t.subMaxLevel,
      i = t.loadSidebar;
    this._renderTo(".sidebar-nav", this.compiler.sidebar(e, n));
    var a = ue(this.router, ".sidebar-nav", !0, !0);
    i && a ? a.parentNode.innerHTML += this.compiler.subSidebar(r) || "" : this.compiler.subSidebar(), this._bindEventOnRendered(a)
  }, Re._bindEventOnRendered = function (e) {
    var t = this.config,
      n = t.autoHeader,
      r = t.auto2top;
    if (function (e) {
        var t = y(".cover.show");
        ve = t ? t.offsetHeight : 0;
        for (var n = f(".sidebar"), r = k(n, "li"), i = 0, a = r.length; i < a; i += 1) {
          var o = r[i],
            s = o.querySelector("a");
          if (s) {
        ...
        if (!p) {
          ...
          L("scroll", function () {
            ...
            return be(d)
          }), S(n, "mouseover", function () {
            ge = !0
          }), S(n, "mouseleave", function () {
            ge = !1
          })
        }
      }(this.router), n && e) {
      ...
      if (a && "H1" !== a.tagName) {
        var o = w("h1");
        o.innerText = e.innerText, _(i, o)
      }
    }
    r && (s = r, void 0 === s && (s = 0), we.scrollTop = !0 === s ? 0 : Number(s));
    var s
  }, Re._renderNav = function (e) {
    e && this._renderTo("nav", this.compiler.compile(e)), ue(this.router, "nav")
  }, Re._renderMain = function (e, t) {
    var n = this;
    if (void 0 === t && (t = {}), !e) return Se.call(this, e);
    u(this, "beforeEach", e, function (e) {
      var r = n.isHTML ? e : n.compiler.compile(e);
      t.updatedAt && (r = _e(r, t.updatedAt, n.config.formatUpdated)), u(n, "afterEach", r, function (e) {
        return Se.call(n, e)
      })
    })
  }, Re._renderCover = function (e, t) {
    var n = f(".cover");
    if (C(f("main"), t ? "add" : "remove", "hidden"), e) {
      C(n, "add", "show");
      ...
      if (i) {
        if ("color" === i[2]) n.style.background = i[1] + (i[3] || "");
          ...
          var a = i[1];
          C(n, "add", "has-mask"), K(i[1]) || (a = Q(this.router.getBasePath(), i[1])), n.style.backgroundImage = "url(" + a + ")", n.style.backgroundSize = "cover", n.style.backgroundPosition = "center center"
        }
        r = r.replace(i[0], "")
      }
      this._renderTo(".cover-main", r), ce()
    } else C(n, "remove", "show")
  }, Re._updateRender = function () {
    ! function (e) {
      var t = f(".app-name-link"),
        n = e.config.nameLink,
        i = e.route.path;
      if (t)
        if (r(e.config.nameLink)) t.setAttribute("href", n);
  ...
  ! function (e) {
    ...
    e._fetch = function (e) {
      ...
      var r = this.route,
        ...
        c = s.loadSidebar,
        u = s.requestHeaders;
      t && t.abort && t.abort(), t = M(this.router.getFile(a) + o, !0, u), this.isHTML = /\.html$/g.test(a);
      var h = function () {
        if (!c) return e();
        Me(a, o, c, function (t) {
      ...
      t.then(function (e, t) {
        ...
        n._renderMain(null), h()
      }), l && Me(a, o, l, function (e) {
      ...
      if (n) {
        ...
        return o ? (o = this.router.getFile(a + o), this.coverIsHTML = /\.html$/g.test(o), M(o + J(i, ["id"]), !1, r).then(function (t) {
    ...
    ke(this.route.path, this.route.query.id), ue(this.router, "nav")
  };
  window.Docsify = {
      util: je,
      dom: E,
      get: M,
      slugify: W
    }, window.DocsifyCompiler = se, window.marked = z, window.Prism = B, qe.version = "4.6.0",
    function (e) {
