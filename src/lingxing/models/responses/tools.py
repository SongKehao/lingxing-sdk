...
class ToolCompetitivemonitorListResponse(LingXingModel):
    ...
    asin_url: Optional[str] = Field(None, description="[string]")
    price: Optional[str] = Field(None, description="[string]")
    currency: Optional[str] = Field(None, description="[string]")
    level_name: Optional[str] = Field(None, description="[string]")
    category_list: Optional[List[ToolCompetitivemonitorListCategoryList]] = Field(None, description="[array]")
    rating: Optional[str] = Field(None, description="[string]")
    star: Optional[str] = Field(None, description="[string]")
    review_num: Optional[str] = Field(None, description="[string]")
    big_category_rank: Optional[str] = Field(None, description="[string]")
    big_category: Optional[str] = Field(None, description="[string]")
    init_big_category_rank: Optional[int] = Field(None, description="[int]")
    small_ranks: Optional[List[ToolCompetitivemonitorListSmallRanks]] = Field(None, description="[array]")
    monitor_status: Optional[int] = Field(None, description="[int]")
    creator_uid: Optional[str] = Field(None, description="[string]")
    monitor_uids: Optional[list] = Field(None, description="[array]")
    creator: Optional[str] = Field(None, description="[string]")
    last_update_event: Optional[list] = Field(None, description="[array]")
    search_term: Optional[str] = Field(None, description="[string]")
    main_image: Optional[str] = Field(None, description="[string]")
    thumbnail: Optional[list] = Field(None, description="[array]")
    featurebullets: Optional[list] = Field(None, description="[array]")
    item_weight: Optional[str] = Field(None, description="[string]")
    product_dimensions: Optional[str] = Field(None, description="[string]")
    init_fbm_seller_num: Optional[int] = Field(None, description="[int]")
    fbm_seller_num: Optional[int] = Field(None, description="[int]")
    init_fba_seller_num: Optional[int] = Field(None, description="[int]")
    fba_seller_num: Optional[int] = Field(None, description="[int]")
    init_buybox_price: Optional[str] = Field(None, description="[string]")
    buybox_price: Optional[str] = Field(None, description="[string]")
    buybox_currency: Optional[str] = Field(None, description="[string]")
    buybox_usd_price: Optional[str] = Field(None, description="[string]")
    avg_price: Optional[str] = Field(None, description="[string]")
    avg_currency: Optional[str] = Field(None, description="[string]")
