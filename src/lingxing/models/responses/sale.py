...
class FbmmanagementModifyfbminventoryResponse(LingXingModel):
    ...
    failure_detail: Optional[List[FbmmanagementModifyfbminventoryFailuredetail]] = Field(
        None, description="错误信息详情"
    )
...
class PublishManageCategorychildrenResponse(LingXingModel):
    ...
    category_children: Optional[List[PublishManageCategorychildrenCategorychildren]] = Field(
        None, description="子类目列表"
    )
...
class PromotionListingdetailcouponRecords(LingXingModel):
    ...
    origin_status: Optional[str] = Field(
        None,
        description="活动状态： ACTIVE 进行中 CANCELED 已取消 EXPIRED 已过期 RUNNING 生效中 NEEDS ACTION 需要注意 EXPIRING SOON 即将过期 SUBMITTED 已提交 FAILED 失败",
    )
...
class PromotionListingdetailprimediscountRecords(LingXingModel):
    ...
    promotion_id: Optional[str] = Field(None, description="活动id，唯一标识")
    customer_target: Optional[str] = Field(
        None, description="消费群体类型 PRIME_EXCLUSIVE会员折扣 ALL CUSTOMERS价格折扣"
    )
...
class PromotionalactivitiesManageListResponse(LingXingModel):
    ...
    currency_icon: Optional[str] = Field(None, description="货币icon")
    origin_status: Optional[str] = Field(
        None, description="活动状态： ACTIVE 进行中 CANCELED 已取消 EXPIRED 已过期 PENDING 未开始"
    )
    promotion_code: Optional[str] = Field(None, description="优惠码")
    sales_amount: Optional[str] = Field(None, description="活动总销售额")
    sales_volume: Optional[str] = Field(None, description="活动总销量")
...
class PromotionalactivitiesSeckillListResponse(LingXingModel):
    ...
    origin_status: Optional[str] = Field(
        None,
        description="活动状态： ACTIVE 进行中 CANCELED 已取消 EXPIRED 已过期 APPROVED 未开始 SUPPRESSED 需要注意 DISMISSED 禁止显示 DRAFT 未定 ENDED 已结束",
    )
...
class PromotionalactivitiesVipdiscountListResponse(LingXingModel):
    ...
    origin_status: Optional[str] = Field(
        None,
        description="活动状态： ACTIVE 进行中 CANCELED 已取消 EXPIRED 已过期 AWAITTING 待上传商品 SCHEDULED 已计划 NEEDS ATTENTION 需要注意 ENDED 已结束",
    )
    promotion_start_time: Optional[str] = Field(None, description="活动开始时间【站点时间】")
    promotion_end_time: Optional[str] = Field(None, description="活动结束时间【站点时间】")
    first_sync_time: Optional[str] = Field(None, description="首次同步时间【站点时间】")
...
class MwsListingDimensionInfo(LingXingModel):
    ...
    item_height_units_type: Optional[str] = Field(
        None,
        description="商品高度单位： unkown未知单位 空字符串 inches(英寸复数,in) inch(英寸单数,in) centimeter(厘米,cm) yard(码,yd) veron(弗隆,fur) foot(英尺,ft)",
    )
    item_length: Optional[str] = Field(None, description="商品长度")
    item_length_units_type: Optional[str] = Field(
        None,
        description="商品长度单位： unkown未知单位 空字符串 inches(英寸复数,in) inch(英寸单数,in) centimeter(厘米,cm) yard(码,yd) veron(弗隆,fur) foot(英尺,ft)",
    )
    item_width: Optional[str] = Field(None, description="商品宽度")
    item_width_units_type: Optional[str] = Field(
        None,
        description="商品宽度单位： unkown未知单位 空字符串 inches(英寸复数,in) inch(英寸单数,in) centimeter(厘米,cm) yard(码,yd) veron(弗隆,fur) foot(英尺,ft)",
    )
    item_weight: Optional[str] = Field(None, description="商品重量")
    item_weight_units_type: Optional[dict] = Field(
        None,
        description="商品重量单位： unkown未知单位 空字符串 pounds(ce(盎司,o磅,ib) kg(千克,kg) ounce(盎司,oz) gram(克,g) carat(克拉,ct)",
    )
    package_height: Optional[str] = Field(None, description="包装高度")
    package_height_units_type: Optional[str] = Field(
        None,
        description="包装高度单位： unkown未知单位 空字符串 inches(英寸复数,in) inch(英寸单数,in) centimeter(厘米,cm) yard(码,yd) veron(弗隆,fur) foot(英尺,ft)",
    )
    package_length: Optional[str] = Field(None, description="包装长度")
    package_length_units_type: Optional[str] = Field(
        None,
        description="包装长度单位： unkown未知单位 空字符串 inches(英寸复数,in) inch(英寸单数,in) centimeter(厘米,cm) yard(码,yd) veron(弗隆,fur) foot(英尺,ft)",
    )
    package_width: Optional[str] = Field(None, description="包装宽度")
    package_width_units_type: Optional[str] = Field(
        None,
        description="包装宽度单位： unkown未知单位 空字符串 inches(英寸复数,in) inch(英寸单数,in) centimeter(厘米,cm) yard(码,yd) veron(弗隆,fur) foot(英尺,ft)",
    )
    package_weight: Optional[str] = Field(None, description="包装重量")
    package_weight_units_type: Optional[str] = Field(
        None,
        description="包装重量单位： unkown未知单位 空字符串 pounds(ce(盎司,o磅,ib) kg(千克,kg) ounce(盎司,oz) gram(克,g) carat(克拉,ct)",
    )
...
class MwsOrderdetailItemList(LingXingModel):
    ...
    order_item_id: Optional[str] = Field(
        None, description="订单商品编码【订单下唯一，但亚马逊返回值可能会发生变更，以最新数据为准】"
    )
    ...
    other_amount: Optional[float] = Field(
        None, description="亚马逊收取的其他费用，比如参与“Amazon Exlusives Program”产生的费用"
    )
...
class MwsOrderdetailResponse(LingXingModel):
    ...
    taxes_included: Optional[int] = Field(
        None,
        description="费用是否含税：1 含税，2 不含税 仅针对欧洲市场订单使用，对应字段如下：item_price_amount、shipping_price_amount、gift_wrap_price_amount、shipping_discount_amount、promotion_discount_amount、cod_fee_amount",
    )
    ...
    payment_method: Optional[str] = Field(
        None,
        description="付款方式： COD (Cash on delivery) CVS（Convenience store） Other（A payment method other than COD and CVS）",
    )
    ...
    earliest_delivery_date: Optional[str] = Field(
        None, description="最早送达时间（承诺送达订单的最早送达时间） 备注：UTC时间"
    )
    latest_delivery_date: Optional[str] = Field(
        None, description="最晚送达时间（承诺送达订单的最晚送达时间） 备注：UTC时间"
    )
...
class MwsOrdersResponse(LingXingModel):
    ...
    is_mcf_order: Optional[int] = Field(
        None, description="是否多渠道订单：0 否，1 是 【2023年后的多渠道订单数据均不在此接口返回】"
    )
...
class AmazonProductAttributes(LingXingModel):
    ...
    # 履约/库存
    fulfillment_availability: Optional[List[AmazonListingFulfillmentAvailability]] = Field(
        None, description="履约可用性"
    )
...
class AmazonProductSearchInfo(LingXingModel):
    ...
    fulfillment_availability: Optional[List[AmazonProductFulfillmentAvailability]] = Field(
        None, description="顶层履约可用性"
    )
...
class AmzodOrderdetailsLogisticsinformationShipmentInfo(LingXingModel):
    ...
    fulfillment_shipment_status: Optional[str] = Field(
        None, description="ship状态： CANCELLED_BY_FULFILLER CANCELLED_BY_SELLER PENDING PROCESSED SHIPPED"
    )
...
class AmzodOrderdetailsLogisticsinformationResponse(LingXingModel):
    ...
    shipment_info: Optional[List[AmzodOrderdetailsLogisticsinformationShipmentInfo]] = Field(
        None, description="配送详情"
    )
...
class AmzodOrderdetailsProductinformationResponse(LingXingModel):
    ...
    ship_date_locale_norm: Optional[str] = Field(None, description="发货时间（站点时间）")
    ship_date_locale_iso: Optional[str] = Field(None, description="发货时间ISO格式（站点时间）")
    listing_detail_info: Optional[List[AmzodOrderdetailsProductinformationListingDetailInfo]] = Field(
        None, description="商品信息"
    )
...
class AmzodOrderdetailsReturninformationResponse(LingXingModel):
    ...
    ship_date_locale_norm: Optional[str] = Field(None, description="发货时间（站点时间）")
    ship_date_locale_iso: Optional[str] = Field(None, description="发货时间ISO格式（站点时间）")
    order_return_replace_tab: Optional[List[AmzodOrderdetailsReturninformationOrderReturnReplaceTab]] = Field(
        None, description="是"
    )
...
class MpOrderGetfulfillmentresultResponse(LingXingModel):
    ...
    processing_summary: Optional[List[MpOrderGetfulfillmentresultProcessingSummary]] = Field(
        None, description="结果汇总"
    )
...
class PromotionapiPromotionCouponalldetailbatchResponse(LingXingModel):
    ...
    listing_page: Optional[List[PromotionapiPromotionCouponalldetailbatchListingpage]] = Field(
        None, description="优惠券涉及的Listing信息"
    )
    order_page: Optional[List[PromotionapiPromotionCouponalldetailbatchOrderpage]] = Field(
        None, description="优惠券涉及的订单信息"
    )
...
class PromotionapiPromotionManagementalldetailbatchManagement(LingXingModel):
    ...
    status_text: Optional[str] = Field(None, description="状态说明")
    origin_status: Optional[str] = Field(None, description="促销活动平台状态")
    promotion_type: Optional[float] = Field(
        None,
        description="活动类型 0未定义 1Best Deal 2Lightning Deal 3买一赠一 4购买折扣 5一口价 6折扣 7金额 8社媒促销 9金额",
    )
...
class PromotionapiPromotionManagementalldetailbatchResponse(LingXingModel):
    ...
    promotion_id: Optional[str] = Field(None, description="活动id")
    store_id: Optional[str] = Field(None, description="店铺id")
    management: Optional[List[PromotionapiPromotionManagementalldetailbatchManagement]] = Field(
        None, description="管理促销信息"
    )
    listing_page: Optional[List[PromotionapiPromotionManagementalldetailbatchListingpage]] = Field(
        None, description="管理促销涉及的Listing信息"
    )
    order_page: Optional[List[PromotionapiPromotionManagementalldetailbatchOrderpage]] = Field(
        None, description="管理促销涉及的订单信息"
    )
...
class PromotionapiPromotionPrimediscountalldetailbatchPrimediscount(LingXingModel):
    ...
    status_text: Optional[str] = Field(None, description="状态说明")
    origin_status: Optional[str] = Field(None, description="促销活动平台状态")
    customer_target: Optional[float] = Field(
        None, description="消费群体类型 PRIME_EXCLUSIVE会员折扣 ALL CUSTOMERS价格折扣"
    )
    ...
    promotion_end_time: Optional[str] = Field(None, description="活动结束时间")
    last_sync_time: Optional[str] = Field(None, description="最后同步时间")
    pull_detail_status: Optional[str] = Field(
        None, description="获取详情状态 0=未获取（获取失败），1=获取中，2=获取成功"
    )
...
class PromotionapiPromotionPrimediscountalldetailbatchResponse(LingXingModel):
    ...
    prime_discount: Optional[List[PromotionapiPromotionPrimediscountalldetailbatchPrimediscount]] = Field(
        None, description="会员折扣or价格折扣信息"
    )
    listing_page: Optional[List[PromotionapiPromotionPrimediscountalldetailbatchListingpage]] = Field(
        None, description="会员折扣or价格折扣涉及的Listing信息"
    )
    order_page: Optional[List[PromotionapiPromotionPrimediscountalldetailbatchOrderpage]] = Field(
        None, description="会员折扣or价格折扣涉及的订单信息"
    )
...
class PromotionapiPromotionSeckillalldetailbatchResponse(LingXingModel):
    ...
    listing_page: Optional[List[PromotionapiPromotionSeckillalldetailbatchListingpage]] = Field(
        None, description="秒杀涉及的Listing信息"
    )
    order_page: Optional[List[PromotionapiPromotionSeckillalldetailbatchOrderpage]] = Field(
        None, description="秒杀涉及的订单信息"
    )
