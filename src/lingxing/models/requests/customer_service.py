...
class ServiceReviewv2Request(LingXingModel):
    ...
    search_field: Optional[str] = None  # 搜索字段: asin ASIN parent_asin 父ASIN remark 备注 amazon_order_id 订单号 author 买家信息 review_id  Review ID buy
...
class ServiceStoreperformancelistRequest(LingXingModel):
    ...
    anomaly_indicator: Optional[list] = None  # 异常指标： commodity_policy_compliance 商品政策合规性 on_time_delivery 准时交货率 valid_tracking 有效追踪率 pre_fulfillmen
