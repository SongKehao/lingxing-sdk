...
class RestockingLimitEndpoints(BaseEndpoint):
    ...
    async def get_ipi_info(self, offset: int = None, length: int = None, seller_ids: str = None, mids: str = None, sids: str = None) -> list[FbalimitRestockGetipiinfoResponse]:
        """查询IPI信息.
...
Args:
    ...
    async def replenishment_restriction_list(self, storage_type: str = None, offset: int = None, length: int = None, sids: str = None) -> list[ReplenishmentrestrictionPageListResponse]:
        """查询补货限制列表.
