...
class MultiplatformAdsEndpoints(BaseEndpoint):
    ...
    async def lazada_audience_report_list(self, page: Any = None, comparison: Any = None, period: Any = None, config: Any = None, filter: Any = None) -> list[AudienceReportListResponse]:
        """Lazada广告-受众报告.
...
Args:
    ...
    async def lazada_campaign_info(self, storeIds: list = None, campaignName: str = None, page: float = None, length: float = None) -> list[LazadaadCampaignInfoResponse]:
        """Lazada广告-获取广告活动信息.
...
Args:
    ...
    async def lazada_campaign_report_list(self, page: Any = None, comparison: Any = None, period: Any = None, config: Any = None, filter: Any = None) -> list[CampaignReportListResponse]:
        """Lazada广告-广告活动报告.
...
Args:
    ...
    async def lazada_item_info(self, storeIds: list = None, campaignIds: list = None, adgroupName: str = None, page: float = None, length: float = None) -> list[LazadaadItemInfoResponse]:
        """Lazada广告-获取广告商品信息.
...
Args:
    ...
    async def lazada_item_report_list(self, page: Any = None, comparison: Any = None, period: Any = None, config: Any = None, filter: Any = None) -> list[ItemReportListResponse]:
        """Lazada广告-广告商品报告.
...
Args:
    ...
    async def lazada_keyword_report_list(self, page: Any = None, comparison: Any = None, period: Any = None, config: Any = None, filter: Any = None) -> list[KeywordReportListResponse]:
        """Lazada广告-关键词报告.
...
Args:
    ...
    async def lazada_seller_info(self, **kwargs) -> LazadaadSellerInfoResponse | None:
        """Lazada广告-获取店铺信息.
...
POST /basicOpen/lazadaAd/seller/info"""
    ...
    async def lazada_store_report_list(self, page: Any = None, comparison: Any = None, period: Any = None, config: Any = None, filter: Any = None) -> list[StoreReportListResponse]:
        """Lazada广告-店铺报告.
...
Args:
    ...
    async def tiktok_common_advertiser_list(self, internalStatus: str = None, hasGmvStore: int = None) -> list[MultiplatformAdsQuerycommonadvertiserlistResponse]:
        """查询TikTok-推广广告-广告帐号.
...
Args:
    ...
    async def tiktok_gmv_store_list(self, **kwargs) -> list[MultiplatformAdsQuerygmvstorelistResponse]:
...
POST /basicOpen/multiplatform/ads/queryGmvStoreList"""
    ...
    async def shopee_campaign_report_list(self, page: Any = None, period: Any = None, filter: Any = None) -> list[CampaignReportList2Response]:
        """分页查询广告活动报告列表.
...
Args:
    ...
    async def shopee_store_report_list(self, page: Any = None, period: Any = None, filter: Any = None) -> list[StoreReportList2Response]:
        """分页查询店铺报告列表.
...
Args:
    ...
    async def tiktok_ad_group_list(self, endDate: str = None, length: int = None, page: int = None, startDate: str = None, advertiserIds: list = None, bidStrategies: list = None, budgetTypes: list = None, campaignIds: list = None, currencies: list = None, objectiveType: list = None, orderField: str = None, orderType: str = None, ownerBcIds: list = None, searchType: str = None, searchValue: list = None, serviceStatus: list = None, status: list = None, summaryCurrency: str = None) -> list[MultiplatformAdsQuerytiktokadgrouplistResponse]:
        """查询TikTok-推广广告-广告组.
...
Args:
    ...
    async def tiktok_ad_list(self, endDate: str = None, length: int = None, page: int = None, startDate: str = None, adIds: list = None, adStyles: list = None, adgroupIds: list = None, advertiserIds: list = None, bidStrategies: list = None, budgetTypes: list = None, campaignIds: list = None, creativeMaterialTypes: list = None, currencies: list = None, orderField: str = None, orderType: str = None, ownerBcIds: list = None, searchType: str = None, searchValue: list = None, serviceStatus: list = None, status: list = None, summaryCurrency: str = None, videoTypes: list = None) -> list[MultiplatformAdsQuerytiktokadlistResponse]:
        """查询TikTok-推广广告-广告.
...
Args:
    ...
    async def tiktok_advertiser_list(self, endDate: str = None, length: int = None, page: int = None, startDate: str = None, advertiserIds: list = None, advertiserType: list = None, bidStrategies: list = None, budgetTypes: list = None, currencies: list = None, displayTimezones: list = None, orderField: str = None, orderType: str = None, ownerBcIds: list = None, searchType: str = None, searchValue: list = None, serviceStatus: list = None, status: list = None, summaryCurrency: str = None) -> list[MultiplatformAdsQueryadvertiserlistResponse]:
        """查询TikTok-推广广告-广告帐号.
...
Args:
    ...
    async def tiktok_campaign_list(self, endDate: str = None, length: int = None, page: int = None, startDate: str = None, advertiserIds: list = None, bidStrategies: list = None, budgetTypes: list = None, campaignIds: list = None, currencies: list = None, objectiveType: list = None, orderField: str = None, orderType: str = None, ownerBcIds: list = None, searchType: str = None, searchValue: list = None, serviceStatus: list = None, status: list = None, summaryCurrency: str = None) -> list[MultiplatformAdsQuerytiktokcampaignlistResponse]:
        """查询TikTok-推广广告-广告系列.
...
Args:
    ...
    async def tiktok_gmv_advertiser_report_list(self, endDate: str = None, length: int = None, page: int = None, startDate: str = None, advertiserIds: list = None, gmvMaxPromotionTypeCodes: list = None, orderField: str = None, orderType: str = None, ownerBcIds: list = None, status: list = None, storeIds: list = None, summaryCurrency: str = None) -> list[MultiplatformAdsQuerygmvadvertiserreportlistResponse]:
...
Args:
    ...
    async def tiktok_gmv_campaign_report_list(self, endDate: str = None, length: int = None, page: int = None, startDate: str = None, advertiserIds: list = None, bidTypeCodes: list = None, campaignId: int = None, campaignIds: list = None, gmvMaxPromotionTypeCodes: list = None, itemGroupIds: list = None, orderField: str = None, orderType: str = None, ownerBcIds: list = None, scheduleEndDate: str = None, scheduleStartDate: str = None, status: list = None, storeIds: list = None, summaryCurrency: str = None) -> list[MultiplatformAdsQuerygmvcampaignreportlistResponse]:
...
Args:
    ...
    async def tiktok_gmv_item_group_report_list(self, endDate: str = None, length: int = None, page: int = None, startDate: str = None, advertiserIds: list = None, bidTypeCodes: list = None, campaignIds: list = None, itemGroupIds: list = None, orderField: str = None, orderType: str = None, ownerBcIds: list = None, status: list = None, storeIds: list = None, summaryCurrency: str = None) -> list[MultiplatformAdsQuerygmvitemgroupreportlistResponse]:
...
Args:
    ...
    async def walmart_campaign_sp_list(self, advertiserIds: list = None, campaignType: list = None, day: int = None, endDate: str = None, operationSourceType: str = None, pageNum: int = None, pageSize: int = None, paging: bool = None, startDate: str = None, campaignIds: list = None, orderField: str = None, orderType: str = None, searchText: str = None, status: list = None) -> list[MultiplatformAdsQuerycampaignsplistResponse]:
        """查询沃尔玛-广告 - SP广告 - 广告活动.
...
Args:
    ...
    async def walmart_group_sp_list(self, advertiserIds: list = None, campaignType: list = None, day: int = None, endDate: str = None, operationSourceType: str = None, pageNum: int = None, pageSize: int = None, paging: bool = None, startDate: str = None, campaignIds: list = None, orderField: str = None, orderType: str = None, searchText: str = None, status: list = None) -> list[MultiplatformAdsQuerygroupsplistResponse]:
        """查询沃尔玛-广告 - SP广告 - 广告组.
...
Args:
    ...
    async def walmart_page_type_sp_list(self, orderType: str = None, adDatePicker: list = None, advertiserIds: list = None, campaignType: list = None, endDate: str = None, pageSize: int = None, campaignIds: list = None, orderField: str = None, day: int = None, pageNum: int = None, startDate: str = None) -> list[MultiplatformAdsQuerypagetypesplistResponse]:
        """查询沃尔玛-广告 - SP广告 - 页面类型.
...
Args:
    ...
    async def walmart_report_ad_item_sp_list(self, advertiserIds: list = None, campaignType: list = None, endDate: str = None, startDate: str = None, adGroupIds: list = None, campaignIds: list = None, day: int = None, orderField: str = None, orderType: str = None, pageNum: int = None, pageSize: int = None, paging: bool = None, searchText: str = None, searchType: str = None, status: list = None) -> list[MultiplatformAdsReportaditemsplistResponse]:
        """查询沃尔玛-广告 - SP广告 - 广告.
...
Args:
    ...
    async def walmart_report_campaign_sv_list(self, advertiserIds: list = None, campaignType: list = None, day: int = None, endDate: str = None, operationSourceType: str = None, pageNum: int = None, pageSize: int = None, paging: bool = None, startDate: str = None, campaignIds: list = None, orderField: str = None, orderType: str = None, searchText: str = None, status: list = None) -> list[MultiplatformAdsReportcampaignsvlistResponse]:
        """查询沃尔玛-广告 - SV广告 - 广告活动.
...
Args:
    ...
    async def walmart_report_keyword_sb_list(self, advertiserIds: list = None, campaignType: list = None, endDate: str = None, startDate: str = None, adGroupIds: list = None, campaignIds: list = None, day: int = None, orderField: str = None, orderType: str = None, pageNum: int = None, pageSize: int = None, paging: bool = None, searchText: str = None, status: list = None) -> list[MultiplatformAdsReportkeywordsblistResponse]:
        """查询沃尔玛-广告 - SB广告 - 关键词.
...
Args:
    ...
    async def walmart_report_platform_sb_list(self, advertiserIds: list = None, campaignType: list = None, endDate: str = None, startDate: str = None, adGroupIds: list = None, campaignIds: list = None, day: int = None, orderField: str = None, orderType: str = None, pageNum: int = None, pageSize: int = None, paging: bool = None, searchText: str = None, searchType: str = None, status: list = None) -> list[MultiplatformAdsReportplatformsblistResponse]:
        """查询沃尔玛-广告 - SB广告 - 平台.
