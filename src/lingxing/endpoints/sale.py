...
class SaleEndpoints(BaseEndpoint):
    ...
    async def add_goods_tag(
        self, tagIds: list = None, bindDetail: list = None
    ) -> ListingmanageBindlistingandtagResponse | None:
        """Listing新增商品标签.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"tagIds": tagIds, "bindDetail": bindDetail}.items() if v is not None},
        )
        return self._parse_one(resp.data, ListingmanageBindlistingandtagResponse)

    async def delete_goods_tag(
        self, globalTagIds: list = None, bindDetail: list = None
    ) -> ListingmanageRemovelistingandtagResponse | None:
        """Listing删除商品标签.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"globalTagIds": globalTagIds, "bindDetail": bindDetail}.items() if v is not None},
        )
    ...
    async def fbm_order_detail(self, order_number: str = None) -> list[OrderOrderGetorderdetailResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"order_number": order_number}.items() if v is not None},
        )
        return self._parse_list(resp.data, OrderOrderGetorderdetailResponse)

    async def fbm_order_list(
        self,
        sid: str = None,
        ...
        start_time: str = None,
        end_time: str = None,
    ) -> list[OrderOrderGetorderlistResponse]:
        """查询亚马逊自发货订单列表.
    ...
    async def get_merchant_shipping_group(
        self, sellerId: str = None, marketplaceId: str = None, productType: str = None, flag: float = None
    ) -> list[PublishManageGetmerchantshippinggroupResponse]:
        """刊登管理-获取运费模板.
    ...
    async def get_prices(self, data: list = None) -> list[ListingListingGetpricesResponse]:
        ...
        resp = await self._post(
            "/listing/listing/open/api/listing/getPrices", {k: v for k, v in {"data": data}.items() if v is not None}
        )
    ...
    async def listing(
        ...
        is_pair: int = None,
        is_delete: int = None,
        pair_update_start_time: str = None,
        pair_update_end_time: str = None,
        listing_update_start_time: str = None,
        listing_update_end_time: str = None,
        search_field: str = None,
        search_value: list = None,
        exact_search: int = None,
        store_type: int = None,
        offset: int = None,
        length: int = None,
    ) -> list[MwsListingResponse]:
        """查询亚马逊Listing.
    ...
    async def order_detail(self, order_id: str = None) -> list[MwsOrderdetailResponse]:
        ...
        resp = await self._post(
            "/erp/sc/data/mws/orderDetail", {k: v for k, v in {"order_id": order_id}.items() if v is not None}
        )
        return self._parse_list(resp.data, MwsOrderdetailResponse)

    async def orderlists(
        self,
        sid: int = None,
        sid_list: list = None,
        start_date: str = None,
        end_date: str = None,
        date_type: int = None,
        order_status: list = None,
        sort_desc_by_date_type: int = None,
        fulfillment_channel: int = None,
        offset: int = None,
        length: int = None,
    ) -> list[MwsOrdersResponse]:
        """查询亚马逊订单列表.
    ...
    async def product_list(
        self,
        record_unique_id: int = None,
        sku: str = None,
        store_id: int = None,
        operate_time: dict = None,
        operate_time_: dict = None,
    ) -> list[AmazonProductListResponse]:
        """刊登管理-查询刊登结果.
    ...
    async def product_publish(self, store_id: float = None, data: dict = None) -> list[AmazonProductPublishResponse]:
        """刊登管理-提交商品资料.
        ...
        resp = await self._post(
            "/listing/publish/openapi/amazon/product/publish",
            {k: v for k, v in {"store_id": store_id, "data": data}.items() if v is not None},
        )
        return self._parse_list(resp.data, AmazonProductPublishResponse)

    async def productlink(self, data: dict = None) -> list[StorageProductLinkResponse]:
        """批量添加/编辑Listing配对.

        POST /erp/sc/storage/product/link"""
        resp = await self._post(
            "/erp/sc/storage/product/link", {k: v for k, v in {"data": data}.items() if v is not None}
        )
    ...
    async def publish_helper_v2(self, storeId: float = None) -> list[PublishManageCategoryrootResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"storeId": storeId}.items() if v is not None},
        )
        return self._parse_list(resp.data, PublishManageCategoryrootResponse)

    async def publish_manage_category_children(
        self, storeId: float = None, categoryUniqueId: float = None
    ) -> list[PublishManageCategorychildrenResponse]:
        """刊登管理-查询 Amazon 子分类.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"storeId": storeId, "categoryUniqueId": categoryUniqueId}.items() if v is not None},
        )
    ...
    async def publish_manage_get_product_type(
        self, marketplaceId: str = None, productTypeOrigin: str = None
    ) -> list[PublishManageGetproducttypeResponse]:
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"marketplaceId": marketplaceId, "productTypeOrigin": productTypeOrigin}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, PublishManageGetproducttypeResponse)

    async def query_product_list(self, store_id: int = None, skus: list = None) -> list[AmazonProductSearchResponse]:
        """查询已有商品信息.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"store_id": store_id, "skus": skus}.items() if v is not None},
        )
    ...
    async def mcf_order_list(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[OrderAmzodApiOrderListResponse]:
        """查询亚马逊多渠道订单列表v2.
    ...
    async def mcf_order_detail_product(self, order_info: list = None) -> list[OrderAmzodProductinformationResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"order_info": order_info}.items() if v is not None},
        )
    ...
    async def mcf_create_order(
        ...
        buyers_mailbox: str = None,
        order_id_for_packing: str = None,
        date_for_packing: str = None,
        remark_for_packing: str = None,
        is_blank_box: str = None,
        is_block_amzl: str = None,
        items: list = None,
    ) -> list[OrderAmzodCreateorderResponse]:
        """创建亚马逊多渠道订单.
    ...
    async def mcf_cancel_order(
        self, sid: int = None, seller_fulfillment_order_id: str = None
    ) -> list[OrderAmzodCancelorderResponse]:
        """取消多渠道订单.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"sid": sid, "seller_fulfillment_order_id": seller_fulfillment_order_id}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, OrderAmzodCancelorderResponse)

    async def mcf_transaction_detail(
        self, sid: int = None, amazon_order_id: str = None
    ) -> list[SalesorderMultiChannelListTransactionResponse]:
        """查询多渠道订单-交易明细.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"sid": sid, "amazonOrderId": amazon_order_id}.items() if v is not None},
        )
        return self._parse_list(resp.data, SalesorderMultiChannelListTransactionResponse)

    async def submit_fulfillment(
        self, region: str = None, seller_id: str = None, marketplace_id: str = None, order_list: list = None
    ) -> list[PbMpOrderSubmitFulfillmentResponse]:
        """亚马逊订单提交标发.
    ...
    async def get_fulfillment_result(
        self, seller_id: str = None, task_id: list = None
    ) -> list[PbMpOrderGetFulfillmentResultResponse]:
        """查询亚马逊标发结果.
        ...
        resp = await self._post(
            "/pb/mp/order/getFulfillmentResult",
            {k: v for k, v in {"seller_id": seller_id, "task_id": task_id}.items() if v is not None},
        )
        return self._parse_list(resp.data, PbMpOrderGetFulfillmentResultResponse)

    async def promotion_coupon_all_detail_batch(
        self, item_list: list = None
    ) -> list[PromotionCouponAllDetailBatchResponse]:
        ...
        resp = await self._post(
            "/promotionApi/open/promotion/couponAllDetailBatch",
            {k: v for k, v in {"itemList": item_list}.items() if v is not None},
        )
        return self._parse_list(resp.data, PromotionCouponAllDetailBatchResponse)

    async def promotion_management_all_detail_batch(
        self, item_list: list = None
    ) -> list[PromotionManagementAllDetailBatchResponse]:
        ...
        Args:
            item_list: 批量请求 1-20个 [{promotionId,storeId,orderPageNum,orderPageSize,listingPageNum,listingPageSize}] (required), array."""
        resp = await self._post(
            "/promotionApi/open/promotion/managementAllDetailBatch",
            {k: v for k, v in {"itemList": item_list}.items() if v is not None},
        )
        return self._parse_list(resp.data, PromotionManagementAllDetailBatchResponse)

    async def promotion_prime_discount_all_detail_batch(
        self, item_list: list = None
    ) -> list[PromotionPrimeDiscountAllDetailBatchResponse]:
        ...
        Args:
            item_list: 批量请求 1-20个 [{promotionId,storeId,orderPageNum,orderPageSize,listingPageNum,listingPageSize}] (required), array."""
        resp = await self._post(
            "/promotionApi/open/promotion/primeDiscountAllDetailBatch",
            {k: v for k, v in {"itemList": item_list}.items() if v is not None},
        )
        return self._parse_list(resp.data, PromotionPrimeDiscountAllDetailBatchResponse)

    async def promotion_sec_kill_all_detail_batch(
        self, item_list: list = None
    ) -> list[PromotionSecKillAllDetailBatchResponse]:
        ...
        Args:
            item_list: 批量请求 1-20个 [{promotionId,storeId,orderPageNum,orderPageSize,listingPageNum,listingPageSize}] (required), array."""
        resp = await self._post(
            "/promotionApi/open/promotion/secKillAllDetailBatch",
            {k: v for k, v in {"itemList": item_list}.items() if v is not None},
        )
        return self._parse_list(resp.data, PromotionSecKillAllDetailBatchResponse)

    async def refund_order(
        self, sid: float = None, amazonOrderId: str = None, purchaseDateLocal: str = None, data: dict = None
    ) -> SalesorderRefundorderResponse | None:
        """订单退款.
        ...
        resp = await self._post(
            "/basicOpen/openapi/salesOrder/refundOrder",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def sc_order_set_remark(
        self, sid: int = None, amazonOrderId: str = None, remark: str = None
    ) -> PlatformorderScorderSetremarkResponse | None:
        """SC订单-设置订单备注.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"sid": sid, "amazonOrderId": amazonOrderId, "remark": remark}.items() if v is not None},
        )
    ...
    async def unlink_listing(self, list_field: list = None) -> ListingmanageUnlinklistingpairsResponse | None:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"list_field": list_field}.items() if v is not None},
        )
        return self._parse_one(resp.data, ListingmanageUnlinklistingpairsResponse)

    async def update_fbm_inventory(
        self, fbmInventoryList: list = None
    ) -> FbmmanagementModifyfbminventoryResponse | None:
        """修改 FBM库存&处理时间.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"fbmInventoryList": fbmInventoryList}.items() if v is not None},
        )
    ...
    async def update_principal(self, sid_asin_list: list = None) -> ListingAsinUpdateprincipalResponse | None:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"sid_asin_list": sid_asin_list}.items() if v is not None},
        )
    ...
    async def upload_tracking(
        ...
        waybillNo: str = None,
        woId: int = None,
    ) -> SelfshipmentorderImportlabelResponse | None:
        """导入面单.
        ...
        resp = await self._post(
            "/basicOpen/selfShipmentOrder/importLabel",
            {
                k: v
                for k, v in {
                    "fileName": fileName,
    ...
    async def adjust_price_adjust_price_manual(
        self,
        offset: float = None,
        length: float = None,
        sid: list = None,
        processing_status: list = None,
        time_type: float = None,
        start_time: str = None,
        end_time: str = None,
        search_field: str = None,
        search_value: list = None,
        tab_status: float = None,
    ) -> list[ModuleAdjustpriceAdjustpricemanualResponse]:
        """查询调价队列.
    ...
    async def after_sale_list(self, **kwargs: Any) -> list[AmzodOrderAftersalelistResponse]:
    ...
    async def b2b_price_modify_price(self, content: list = None) -> list[B2bpriceModifypriceResponse]:
        ...
        resp = await self._post(
            "/basicOpen/b2bPrice/modifyPrice", {k: v for k, v in {"content": content}.items() if v is not None}
        )
        return self._parse_list(resp.data, B2bpriceModifypriceResponse)

    async def fba_fee_difference_list(
        self,
        offset: int = None,
        length: int = None,
        start_date: str = None,
    ...
    ) -> list[FbafeedifferenceOrderListResponse]:
        """FBA费差异-异常订单-订单.
    ...
    async def fba_fee_difference_msku_list(
        self,
        offset: int = None,
        length: int = None,
        start_date: str = None,
        ...
        search_field: str = None,
        search_value: str = None,
    ) -> list[FbafeedifferenceMskuListResponse]:
        """FBA费差异-异常订单-MSKU.
    ...
    async def global_tag_add_tag(self, tag_name: str = None) -> GlobaltagListingAddtagResponse | None:
        ...
        resp = await self._post(
            "/basicOpen/globalTag/listing/addTag", {k: v for k, v in {"tag_name": tag_name}.items() if v is not None}
        )
        return self._parse_one(resp.data, GlobaltagListingAddtagResponse)

    async def global_tag_page_list(
        self, offset: int = None, length: int = None, search_field: str = None, search_value: str = None
    ) -> list[ListingPageListResponse]:
        """查询Listing标签列表.
        ...
        resp = await self._post(
            "/basicOpen/globalTag/listing/page/list",
            {
                k: v
                for k, v in {
                    "offset": offset,
    ...
    async def global_tag_remove_tag(self, tag_ids: list = None) -> GlobaltagListingRemovetagResponse | None:
        """删除Listing标签.
        ...
        resp = await self._post(
            "/basicOpen/globalTag/listing/removeTag", {k: v for k, v in {"tag_ids": tag_ids}.items() if v is not None}
        )
        return self._parse_one(resp.data, GlobaltagListingRemovetagResponse)

    async def listing_operate_log_page_list(
        self,
        sid: str = None,
        msku: str = None,
        offset: int = None,
        length: int = None,
        operate_uid: list = None,
        operate_type: list = None,
        operate_time_start: str = None,
        operate_time_end: str = None,
    ) -> list[ListingmanageListingoperatelogPagelistResponse]:
        """查询Listing操作日志列表.
    ...
    async def pricing_submit(self, pricing_params: list = None) -> ListingProductpricingPricingsubmitResponse | None:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"pricing_params": pricing_params}.items() if v is not None},
        )
        return self._parse_one(resp.data, ListingProductpricingPricingsubmitResponse)

    async def product_relationbatch_link(
        self, productId: float = None, isSyncPic: float = None, sidAsins: list = None
    ) -> VcserviceProductrelationBatchlinkResponse | None:
        """配对/批量配对.
        ...
        resp = await self._post(
            "/basicOpen/vcservice/productRelation/batchLink",
            {
                k: v
                for k, v in {"productId": productId, "isSyncPic": isSyncPic, "sidAsins": sidAsins}.items()
                if v is not None
            },
        )
        return self._parse_one(resp.data, VcserviceProductrelationBatchlinkResponse)

    async def promotion_listing_detail_coupon(
        self,
        sellerSku: str = None,
        promotionType: list = None,
        status: list = None,
        storeId: str = None,
        startTime: str = None,
        endTime: str = None,
        ...
        pageNum: float = None,
        pageSize: float = None,
    ) -> list[PromotionListingdetailcouponResponse]:
        """查询商品折扣详情-列表-优惠卷.
        ...
        resp = await self._post(
            "/basicOpen/promotion/listingDetailCoupon",
            {
                k: v
                for k, v in {
                    "sellerSku": sellerSku,
    ...
    async def promotion_listing_detail_manage(
        self,
        sellerSku: str = None,
        promotionType: list = None,
        status: list = None,
        ...
        pageNum: float = None,
        pageSize: float = None,
    ) -> list[PromotionListingdetailmanageResponse]:
        """查询商品折扣详情-列表-管理促销.
        ...
        Args:
            ...
            pageSize: 分页大小 (required), number."""
        resp = await self._post(
            "/basicOpen/promotion/listingDetailManage",
            {
                k: v
                for k, v in {
                    "sellerSku": sellerSku,
    ...
    async def promotion_listing_detail_prime_discount(
        self,
        sellerSku: str = None,
        promotionType: list = None,
        status: list = None,
        ...
        pageNum: float = None,
        pageSize: float = None,
    ) -> list[PromotionListingdetailprimediscountResponse]:
        """查询商品折扣详情-列表-会员折扣.
        ...
        Args:
            ...
            pageSize: 分页大小 (required), number."""
        resp = await self._post(
            "/basicOpen/promotion/listingDetailPrimeDiscount",
            {
                k: v
                for k, v in {
                    "sellerSku": sellerSku,
    ...
    async def promotion_listing_detail_sec_kill(
        self,
        sellerSku: str = None,
        promotionType: list = None,
        status: list = None,
        ...
        pageNum: float = None,
        pageSize: float = None,
    ) -> list[PromotionListingdetailseckillResponse]:
        """查询商品折扣详情-列表-秒杀.
        ...
        Args:
            ...
            pageSize: 分页大小 (required), number."""
        resp = await self._post(
            "/basicOpen/promotion/listingDetailSecKill",
            {
                k: v
                for k, v in {
                    "sellerSku": sellerSku,
    ...
    async def promotion_listing_list(
        self,
        site_date: str = None,
        start_time: str = None,
        end_time: str = None,
        ...
        sids: list = None,
        status: list = None,
        product_status: list = None,
        promotion_category: list = None,
    ) -> list[PromotionListinglistResponse]:
        """查询商品折扣列表.
    ...
    async def promotional_activities_coupon_list(
        self, start_date: str = None, end_date: str = None, sids: list = None, offset: int = None, length: int = None
    ) -> list[PromotionalactivitiesCouponListResponse]:
        """查询促销活动列表-优惠券.
    ...
    async def promotional_activities_manage_list(
        self, start_date: str = None, end_date: str = None, sids: list = None, offset: int = None, length: int = None
    ) -> list[PromotionalactivitiesManageListResponse]:
        """查询促销活动列表-管理促销.
    ...
    async def promotional_activities_sec_kill_list(
        self, start_date: str = None, end_date: str = None, sids: list = None, offset: int = None, length: int = None
    ) -> list[PromotionalactivitiesSeckillListResponse]:
        """查询促销活动列表-秒杀.
    ...
    async def promotional_activities_vip_discount_list(
        self, start_date: str = None, end_date: str = None, sids: list = None, offset: int = None, length: int = None
    ) -> list[PromotionalactivitiesVipdiscountListResponse]:
        """查询促销活动列表-会员折扣/价格折扣.
    ...
    async def query_listing_relation_tag_list(
        self, **kwargs: Any
    ) -> list[ListingmanageQuerylistingrelationtaglistResponse]:
