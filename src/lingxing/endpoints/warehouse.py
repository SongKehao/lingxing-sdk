...
class BinRecommendListItemReq(TypedDict, total=False):
    wid: str
    productId: str
    fnsku: str
    sid: str
...
class PurchaseReceiptListItemReq(TypedDict, total=False):
...
class AllocationProductListItemReq(TypedDict, total=False):
    product_id: int
    fnsku: str
...
class PackingBoxListItemReq(TypedDict, total=False):
    customBoxId: str
    boxLength: str
    boxWidth: str
    boxHeight: str
...
class WarehouseEndpoints(BaseEndpoint):
    async def oversea_sku_unmatch(
        self, data: OverseaSkuUnmatchReq | None = None
    ) -> list[OverseaProductUnmatchResponse]:
        """海外仓sku取消配对.
    ...
    async def product_bin_recommend_list(
        self, data: ProductBinRecommendListReq | None = None
    ) -> list[WarehouseBinEntryRecommendResponse]:
        """查询产品仓位列表.
    ...
    async def oversea_stockorder_detail(self, overseas_order_no: str = None) -> list[OverseaStockOrderDetailResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"overseas_order_no": overseas_order_no}.items() if v is not None},
        )
        return self._parse_list(resp.data, OverseaStockOrderDetailResponse)

    async def create_purchase_receipt_order(
        self, data: CreatePurchaseReceiptOrderReq | None = None
    ) -> list[PurchaseReceiptOrderCreateResponse]:
        """创建待收货的收货单.
    ...
    async def sales_return_order_list(
        self,
        offset: int = None,
        length: int = None,
        time_type: int = None,
        ...
        store_id: int = None,
        wid: int = None,
    ) -> list[SalesReturnV2ListResponse]:
        """查询销售退货单列表.
    ...
    async def qc_order_list(
        ...
        status: int = None,
        wid: int = None,
    ) -> list[ReceiptOrderQcListResponse]:
        """查询质检单列表.
        ...
        Args:
            ...
            wid: see API doc, int."""
        resp = await self._post(
            "/erp/sc/routing/deliveryReceipt/ReceiptOrderQc/getOrderList",
            {
                k: v
                for k, v in {
                    "offset": offset,
    ...
    async def return_order_fast_storage_in(
        self, data: ReturnOrderFastStorageInReq | None = None
    ) -> list[ReturnOrderFastStorageInResponse]:
        """待收货退货单快捷入库.
    ...
    async def allocation_partly_receive(
        self, data: AllocationPartlyReceiveReq | None = None
    ) -> list[AllocationPartlyReceiveResponse]:
        """调拨单分批收货.
        ...
        Args:
            data: 请求体，字段参考接口文档, dict."""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAllocation/partlyReceiveAllocationOrder", data or {}
        )
        return self._parse_list(resp.data, AllocationPartlyReceiveResponse)

    async def allocation_finish_receive(
        self, data: AllocationFinishReceiveReq | None = None
    ) -> list[AllocationFinishReceiveResponse]:
        """调拨单结束到货.
        ...
        Args:
            data: 请求体，字段参考接口文档, dict."""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAllocation/finishReceiveAllocationOrder", data or {}
        )
        return self._parse_list(resp.data, AllocationFinishReceiveResponse)

    async def cost_change_finish(self, data: CostChangeFinishReq | None = None) -> list[CostChangeFinishResponse]:
        """创建已完成的成本补录单.
    ...
    async def set_order_package_size(
        self, data: SetOrderPackageSizeReq | None = None
    ) -> list[WmsOrderSetPackageSizeResponse]:
        """设置包裹尺寸.
    ...
    async def awd_cancel(self, data: AwdCancelReq | None = None) -> list[AwdInboundPlanCancelResponse]:
        """取消AWD入库任务.
    ...
    async def awd_confirm(self, data: AwdConfirmReq | None = None) -> list[AwdInboundPlanConfirmResponse]:
        """确认AWD入库任务.
    ...
    async def awd_create(self, data: AwdCreateInboundPlanReq | None = None) -> list[AwdInboundPlanCreateResponse]:
        """创建AWD入库任务.
    ...
    async def awd_detail(self, order_id: str = None, sid: int = None) -> list[AwdInboundPlanDetailResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"orderId": order_id, "sid": sid}.items() if v is not None},
        )
    ...
    async def awd_list(
        ...
        length: int = None,
    ) -> list[AwdInboundPlanPageResponse]:
        """查询AWD入库任务列表.
        ...
        Args:
            ...
            length: see API doc, int."""
        resp = await self._post(
            "/amzStaServer/openapi/awd/inbound-plan/page",
            {
                k: v
                for k, v in {
                    "page": page,
    ...
    async def awd_update(self, data: AwdUpdateReq | None = None) -> list[AwdInboundPlanUpdateResponse]:
        """更新AWD入库任务.
    ...
    async def awd_shipment_detail(
        self, shipment_id: str = None, sid: int = None
    ) -> list[AwdInboundShipmentDetailResponse]:
        """查询AWD入库货件详情.
        ...
        Args:
            ...
            sid: see API doc, int."""
        resp = await self._post(
            "/amzStaServer/openapi/awd/inbound-shipment/detail",
            {k: v for k, v in {"shipmentId": shipment_id, "sid": sid}.items() if v is not None},
        )
        return self._parse_list(resp.data, AwdInboundShipmentDetailResponse)

    async def awd_shipment_list(
        self,
        page: int = None,
        date_type: int = None,
        start_date_time: str = None,
        ...
        status_list: list = None,
        length: int = None,
    ) -> list[AwdInboundShipmentPageResponse]:
        """查询AWD入库货件列表.
    ...
    async def awd_shipment_update_track(
        self, data: AwdShipmentUpdateTrackReq | None = None
    ) -> list[AwdInboundShipmentUpdateTrackResponse]:
        """更新AWD货件跟踪编号.
    ...
    async def awd_shipment_print_label(
        self, data: AwdShipmentPrintLabelReq | None = None
    ) -> list[AwdInboundShipmentPrintLabelResponse]:
        """打印AWD入库货件箱子标签.
    ...
    async def packing_task_add(self, data: PackingTaskAddReq | None = None) -> list[PackingTaskAddResponse]:
        """装箱任务-生成装箱任务.
    ...
    async def packing_task_batch_edit(
        self, data: PackingTaskBatchEditReq | None = None
    ) -> list[PackingTaskBatchEditResponse]:
        """装箱任务-批量编辑装箱信息.
    ...
    async def packing_task_del(self, data: PackingTaskDelReq | None = None) -> list[PackingTaskDelResponse]:
        """装箱任务-删除装箱任务.
    ...
    async def packing_task_detail(self, pt_id: int = None) -> list[PackingTaskDetailResponse]:
        ...
        resp = await self._post(
            "/basicOpen/packingTask/taskDetail", {k: v for k, v in {"ptId": pt_id}.items() if v is not None}
        )
        return self._parse_list(resp.data, PackingTaskDetailResponse)

    async def packing_task_finish(self, data: PackingTaskFinishReq | None = None) -> list[PackingTaskFinishResponse]:
        """装箱任务-标记已完成.
    ...
    async def packing_task_list(
        self,
        relate_sn_type: int = None,
        start_date: str = None,
        end_date: str = None,
        search_field: str = None,
        search_value: str = None,
    ) -> list[PackingTaskListResponse]:
        """装箱任务-单据列表.
        ...
        resp = await self._post(
            "/basicOpen/packingTask/getRelateSnList",
            {
                k: v
                for k, v in {
                    "relateSnType": relate_sn_type,
    ...
    async def process_plan_list(
        ...
        search_key: str = None,
        search_value: str = None,
        search_time_key: str = None,
        search_time_start: str = None,
        search_time_end: str = None,
        senior_search_list: list = None,
    ) -> list[ProcessPlanListResponse]:
        """查询加工计划列表.
        ...
        resp = await self._post(
            "/basicOpen/openapi/workOrder/processPlanList",
            {
                k: v
                for k, v in {
                    "offset": offset,
                    ...
                    "search_time_key": search_time_key,
    ...
    async def process_order_add(self, data: ProcessOrderAddReq | None = None) -> list[ProcessOrderAddResponse]:
        """创建加工单/拆分单.
    ...
    async def process_order_list(
        ...
        Args:
            ...
            length: see API doc, int."""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageProcess/getOrderLists",
            {
                k: v
                for k, v in {
                    "type": operate_type,
    ...
    async def add_allocation_order(
        self,
        wid: int = None,
        sys_wid: int = None,
        to_wid: int = None,
        sys_to_wid: int = None,
        freight_fee: str = None,
        other_fee: str = None,
        fee_part_type: int = None,
        remark: str = None,
        type: int = None,
        predict_time: str = None,
        out_bin_type: str = None,
        product_list: list = None,
        out_available_bin: list = None,
        out_inferior_bin: list = None,
        to_available_bin: list = None,
        to_inferior_bin: list = None,
    ) -> InventoryreceiptStorageallocationAddallocationorderResponse | None:
        """创建待收货/已完成的调拨单.
        ...
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAllocation/addAllocationOrder",
            {
                k: v
                for k, v in {
                    "wid": wid,
    ...
    async def adjust_order_confirm(self, orderSn: list = None) -> AdjustorderAdjustSetadjustResponse | None:
        ...
        Args:
            orderSn: 调整单单号, array."""
        resp = await self._post(
            "/basicOpen/adjustOrder/adjust/setAdjust", {k: v for k, v in {"orderSn": orderSn}.items() if v is not None}
        )
    ...
    async def cancel_storage_allocation_list(self, order_sn: str = None) -> dict:
        ...
        resp = await self._post(
            "/basicOpen/storageAllocationList/cancel",
    ...
    async def create_inbound(
        self,
        inbound_order_no: str = None,
        custom_s_wid: str = None,
        s_wid: int = None,
        r_wid: int = None,
        ...
        remark: str = None,
        file_id: str = None,
        overseas_type: int = None,
        real_delivery_time: str = None,
        logistics_list_type: int = None,
        method_id: str = None,
        custom_fields: dict = None,
        logistics_list: list = None,
        product_list: list = None,
        head_logistics_list: dict = None,
    ) -> OwmsInboundCreateinboundResponse | None:
        """创建待发货/待收货/已完成的备货单.
        ...
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/createInbound",
            {
                ...
                for k, v in {
                    ...
                    "logistics_list_type": logistics_list_type,
                    "method_id": method_id,
    ...
    async def delete_fba_shipment_list(self, shipment_nos: list = None) -> dict:
        """删除发货单.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"shipment_nos": shipment_nos}.items() if v is not None},
        )
        return resp.data or {}

    async def delete_over_sea_stock_order(self, overseas_order_nos: list = None) -> dict:
        """删除备货单.
        ...
        resp = await self._post(
            "/basicOpen/overSeaWarehouse/stockOrder/delete",
            {k: v for k, v in {"overseas_order_nos": overseas_order_nos}.items() if v is not None},
        )
        return resp.data or {}

    async def delete_storage_allocation_list(self, orderSn: list = None) -> dict:
        """删除调拨单.
        ...
        resp = await self._post(
            "/basicOpen/storageAllocationList/delete", {k: v for k, v in {"orderSn": orderSn}.items() if v is not None}
        )
        return resp.data or {}
    ...
    ) -> list[FbaFbastockFbalistResponse]:
        """查询FBA库存列表.
    ...
    async def fba_stock_v2(
        ...
        bid: str = None,
        attribute: int = None,
        asin_principal: str = None,
        status: str = None,
        senior_search_list: str = None,
        fulfillment_channel_type: str = None,
        is_hide_zero_stock: int = 0,
        is_parant_asin_merge: int = 0,
        is_contain_del_ls: int = 0,
        query_fba_storage_quantity_list: bool = None,
        is_cost_page: int = 0,
        sort_field: str = "sku",
        sort_type: str = "asc",
    ) -> list[StorageFbawarehousedetailResponse]:
        """查询FBA库存列表-v2.
        ...
        resp = await self._post(
            "/basicOpen/openapi/storage/fbaWarehouseDetail",
            {
                ...
                for k, v in {
                    ...
                    "is_parant_asin_merge": is_parant_asin_merge,
                    "is_contain_del_ls": is_contain_del_ls,
                    "query_fba_storage_quantity_list": query_fba_storage_quantity_list,
                    "is_cost_page": is_cost_page,
    ...
    async def fast_receive(
        self,
        order_sn: str = None,
        expect_arrival_time: str = None,
        custom_receive_time: str = None,
        logistics_company: str = None,
        logistics_order_no: str = None,
    ...
    async def get_adjust_order_confirm_result(
        self, taskNo: str = None
    ) -> AdjustorderAdjustGetadjuststatusResponse | None:
        """查询调整单确认调整异步结果.
        ...
        resp = await self._post(
            "/basicOpen/adjustOrder/adjust/getAdjustStatus",
            {k: v for k, v in {"taskNo": taskNo}.items() if v is not None},
        )
        return self._parse_one(resp.data, AdjustorderAdjustGetadjuststatusResponse)

    async def get_batch_detail_list(
        self,
        offset: int = None,
        length: int = None,
        show_zero_stock: int = None,
        wids: str = None,
        stock_in_type_list: str = None,
        search_field: str = None,
        search_value: str = None,
    ) -> list[LocalInventoryGetbatchdetaillistResponse]:
        """查询批次明细.
        ...
        resp = await self._post(
            "/erp/sc/routing/data/local_inventory/getBatchDetailList",
            {
                ...
                for k, v in {
                    ...
                    "wids": wids,
                    "stock_in_type_list": stock_in_type_list,
                    "search_field": search_field,
                    "search_value": search_value,
                }.items()
                if v is not None
    ...
    async def get_batch_statement_list(
        self,
        statement_type_list: str = None,
        search_field: str = None,
        search_value: str = None,
        wid_list: str = None,
        offset: int = None,
        length: int = None,
    ) -> list[LocalInventoryGetbatchstatementlistResponse]:
        """查询批次流水.
        ...
        Args:
            ...
            length: 分页长度，默认20，上限400, int."""
        resp = await self._post(
            "/erp/sc/routing/data/local_inventory/getBatchStatementList",
            {
                k: v
                for k, v in {
                    "statement_type_list": statement_type_list,
                    "search_field": search_field,
                    "search_value": search_value,
                    "wid_list": wid_list,
                    "offset": offset,
    ...
    async def get_receive_good_records(
        self,
        overseas_order_no: str = None,
        start_date: str = None,
        end_date: str = None,
        offset: int = None,
        length: int = None,
    ) -> list[OwmsInboundGetreceivegoodrecordsResponse]:
        """查询备货单收货记录.
        ...
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/getReceiveGoodRecords",
            {
                k: v
                for k, v in {
                    "overseas_order_no": overseas_order_no,
                    "start_date": start_date,
                    "end_date": end_date,
                    "offset": offset,
                    "length": length,
    ...
    async def inbound_order_confirm(self, orderSn: list = None) -> InboundorderInboundSetinboundResponse | None:
        ...
        Args:
            orderSn: 入库单单号, array."""
        resp = await self._post(
            "/basicOpen/inboundOrder/inbound/setInbound",
            {k: v for k, v in {"orderSn": orderSn}.items() if v is not None},
        )
        return self._parse_one(resp.data, InboundorderInboundSetinboundResponse)

    async def inventory_details(
        self, wid: str = None, offset: int = None, length: int = None, sku: str = None
    ) -> list[InventoryDetailsItem]:
        """查询仓库库存明细.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"wid": wid, "offset": offset, "length": length, "sku": sku}.items() if v is not None},
        )
    ...
    async def order_add(
        ...
        inbound_idempotent_code: str = None,
        product_list: list = None,
    ) -> StorageStorageOrderaddResponse | None:
        """添加入库单.
    ...
    async def order_add_out(
        ...
        bin_type: int = None,
        product_list: list = None,
    ) -> StorageStorageOrderaddoutResponse | None:
        """添加出库单.
    ...
    async def outbound_order_confirm(self, orderSn: list = None) -> OutboundorderOutboundSetoutboundResponse | None:
        ...
        Args:
            orderSn: 出库单单号, array."""
        resp = await self._post(
            "/basicOpen/outboundOrder/outbound/setOutbound",
            {k: v for k, v in {"orderSn": orderSn}.items() if v is not None},
        )
        return self._parse_one(resp.data, OutboundorderOutboundSetoutboundResponse)

    async def over_seas_stock_detail(
        self, overseas_order_no: str = None
    ) -> list[OverseawarehouseStockorderDetailResponse]:
        """查询备货单详情.
    ...
    async def oversea_warehouse_match_list(
        self,
        wpId: int = None,
        twIds: str = None,
        offset: int = None,
        ...
        isMatched: int = None,
        keyword: str = None,
    ) -> list[OverseawarehousesettingMatchlistResponse]:
        """查询海外仓sku配对列表.
        ...
        resp = await self._post(
            "/basicOpen/overseaWarehouseSetting/matchList",
            {
                k: v
                for k, v in {
                    "wpId": wpId,
    ...
    async def oversea_warehouse_product_match(
        self,
        twId: int = None,
        twpId: int = None,
        wpId: int = None,
        ...
        resp = await self._post(
            "/basicOpen/overseaWarehouseSetting/productMatch",
            {
                k: v
                for k, v in {
                    "twId": twId,
    ...
    async def oversea_warehouse_product_un_match(self, wpId: str = None, wpmId: str = None) -> list | dict:
        ...
        resp = await self._post(
            "/basicOpen/overseaWarehouseSetting/productUnMatch",
            {k: v for k, v in {"wpId": wpId, "wpmId": wpmId}.items() if v is not None},
        )
        if isinstance(resp.data, list):
            return resp.data
        return resp.data or {}

    async def purchase_receipt_order_list(
        self,
        date_type: int = None,
        start_date: str = None,
        end_date: str = None,
        ...
        offset: int = None,
        length: int = None,
    ) -> tuple[list[PurchaseReceiptOrderListItem], int]:
        """查询收货单列表.
    ...
    async def receive(
        ...
        Args:
            ...
            item_list: 收货明细 (required), array."""
        resp = await self._post(
            "/erp/sc/routing/deliveryReceipt/PurchaseReceiptOrder/receive",
            {
                k: v
                for k, v in {
                    "order_sn": order_sn,
    ...
    async def send_inbound(self, overseas_order_no: str = None) -> dict:
        ...
        Args:
            overseas_order_no: 备货单号 (required), string."""
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/sendInbound",
            {k: v for k, v in {"overseas_order_no": overseas_order_no}.items() if v is not None},
        )
        return resp.data or {}
    ...
    async def set_inbound_order_revoke(self, order_sn: str = None, delete_receipt_order: int = None) -> list | dict:
        ...
        resp = await self._post(
            "/basicOpen/inboundOrder/inbound/setOrderRevoke",
            {
                k: v
                for k, v in {"order_sn": order_sn, "delete_receipt_order": delete_receipt_order}.items()
                if v is not None
            },
        )
        if isinstance(resp.data, list):
    ...
    async def set_outbound_order_revoke(self, order_sn: str = None) -> list | dict:
        ...
        resp = await self._post(
            "/basicOpen/outboundOrder/outbound/setOrderRevoke",
            {k: v for k, v in {"order_sn": order_sn}.items() if v is not None},
        )
        if isinstance(resp.data, list):
            return resp.data
    ...
    async def update_logistics(
        ...
        Args:
            ...
            head_logistics_list: 新版头程物流信息（当logistics_list_type 为1时才有意义） (required), object."""
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/updateLogistics",
            {
                k: v
                for k, v in {
                    "overseas_order_no": overseas_order_no,
    ...
    async def warehouse_lists(
        self, type: int = None, sub_type: int = None, is_delete: str = None, offset: int = None, length: int = None
    ) -> list[WarehouseListsItem]:
        """查询仓库列表.
    ...
    async def warehouse_statement_new(
        self,
        wids: str = None,
        types: str = None,
        sub_types: str = None,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[WarehouseStatementNewItem]:
        """查询库存流水（新）.
    ...
    async def wms_order_detail(
        self, isPrintCenter: int = None, orderNumbers: str = None
    ) -> list[WmsorderGetwmsordersbyordernumbersResponse]:
        """查询销售出库单详情.
        ...
        resp = await self._post(
            "/basicOpen/wmsOrder/getWmsOrdersByOrderNumbers",
            {k: v for k, v in {"isPrintCenter": isPrintCenter, "orderNumbers": orderNumbers}.items() if v is not None},
        )
        return self._parse_list(resp.data, WmsorderGetwmsordersbyordernumbersResponse)

    async def wms_order_list(
        self,
        page: int = None,
        page_size: int = None,
        sid_arr: list = None,
        status_arr: list = None,
        logistics_status_arr: list = None,
        platform_order_no_arr: list = None,
        order_number_arr: list = None,
        wo_number_arr: list = None,
        time_type: str = None,
        start_date: str = None,
        end_date: str = None,
    ) -> list[WmsOrderListItem]:
        """查询销售出库单列表.
        ...
        resp = await self._post(
            "/erp/sc/routing/wms/order/wmsOrderList",
            {
                ...
                for k, v in {
                    ...
                    "logistics_status_arr": logistics_status_arr,
    ...
    async def add_adjustment_order(
        self, wid: int = None, remark: str = None, product_list: list = None
    ) -> InventoryreceiptStorageadjustmentAddadjustmentorderResponse | None:
        """创建已完成的数量调整单.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"wid": wid, "remark": remark, "product_list": product_list}.items() if v is not None},
        )
        return self._parse_one(resp.data, InventoryreceiptStorageadjustmentAddadjustmentorderResponse)

    async def add_rebrand_adjustment_order(
        self, wid: int = None, remark: str = None, bin_type: int = None, product_list: list = None
    ) -> InventoryreceiptStorageadjustmentAddrebrandadjustmentorderResponse | None:
        """创建已完成的换标调整单.
        ...
        Args:
            ...
            product_list: 调整的产品明细数据 (required), array."""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAdjustment/addRebrandAdjustmentOrder",
            {
                k: v
                for k, v in {"wid": wid, "remark": remark, "bin_type": bin_type, "product_list": product_list}.items()
                if v is not None
            },
        )
        return self._parse_one(resp.data, InventoryreceiptStorageadjustmentAddrebrandadjustmentorderResponse)

    async def add_sku_adjustment_order(
        self, wid: int = None, remark: str = None, bin_type: int = None, product_list: list = None
    ) -> InventoryreceiptStorageadjustmentAddskuadjustmentorderResponse | None:
        """创建已完成的SKU调整单.
        ...
        Args:
            ...
            product_list: 调整的产品明细数据 (required), array."""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAdjustment/addSkuAdjustmentOrder",
            {
                k: v
                for k, v in {"wid": wid, "remark": remark, "bin_type": bin_type, "product_list": product_list}.items()
                if v is not None
    ...
    async def add_storage_process_order(
        self, type: int = None, wid: int = None, remark: str = None, product_list: list = None
    ) -> InventoryreceiptStorageprocessAddstorageprocessorderResponse | None:
        """创建加工单 / 拆分单.
        ...
        Args:
            ...
            product_list: 产品信息 (required), array."""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageProcess/addStorageProcessOrder",
            {
                k: v
                for k, v in {"type": type, "wid": wid, "remark": remark, "product_list": product_list}.items()
                if v is not None
            },
        )
    ...
    async def bin_create(self, wid: int = None, code: str = None, type: int = None) -> dict:
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/wareHouseBin/create",
            {k: v for k, v in {"wid": wid, "code": code, "type": type}.items() if v is not None},
        )
        return resp.data or {}

    async def cancel_wms_order(
        self, orderNumbers: list = None, tagType: str = None, orderComment: str = None
    ) -> WmsorderCancelResponse | None:
        """销售出库单截单.
        ...
        resp = await self._post(
            "/basicOpen/wmsOrder/cancel",
            {
                k: v
                for k, v in {"orderNumbers": orderNumbers, "tagType": tagType, "orderComment": orderComment}.items()
                if v is not None
            },
        )
        return self._parse_one(resp.data, WmsorderCancelResponse)

    async def check_add_order(
        self,
        wid: int = None,
        is_display_check: int = None,
        check_uid: int = None,
        remark: str = None,
        product_list: list = None,
    ) -> InventoryreceiptInventorycheckAddorderResponse | None:
        """创建已完成的盘点单.
        ...
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/InventoryCheck/addOrder",
            {
                k: v
                for k, v in {
                    "wid": wid,
    ...
    async def check_get_order_detail(
        self,
        order_sn: str = None,
        search_field: str = None,
        search_value: str = None,
        ...
        page: int = None,
        page_size: int = None,
    ) -> list[InventoryreceiptInventorycheckGetorderdetailResponse]:
        """查询盘点单详情.
    ...
    async def check_get_order_list(
        self,
        wid: str = None,
        check_type: str = None,
        date_field: str = None,
        ...
        page: int = None,
        page_size: int = None,
    ) -> list[InventoryreceiptInventorycheckGetorderlistResponse]:
        """查询盘点单列表.
        ...
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/InventoryCheck/getOrderList",
            {
                k: v
                for k, v in {
                    "wid": wid,
    ...
    async def create_receipt_order(self, **kwargs: Any) -> dict:
        """写操作 createReceiptOrder. POST /erp/sc/routing/deliveryReceipt/PurchaseReceiptOrder/createReceiptOrder"""
        resp = await self._post(
            "/erp/sc/routing/deliveryReceipt/PurchaseReceiptOrder/createReceiptOrder", kwargs if kwargs else None
        )
        return resp.data or {}

    async def finish_receive_allocation_order(self, **kwargs: Any) -> dict:
        """写操作 finishReceiveAllocationOrder. POST /erp/sc/routing/inventoryReceipt/StorageAllocation/finishReceiveAllocationOrder"""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAllocation/finishReceiveAllocationOrder",
    ...
    async def get_packing_data(self, overseas_order_no: str = None) -> list[OwmsInboundGetpackingdataResponse]:
        ...
        Args:
            overseas_order_no: 备货单号 (required), string."""
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/getPackingData",
            {k: v for k, v in {"overseas_order_no": overseas_order_no}.items() if v is not None},
        )
        return self._parse_list(resp.data, OwmsInboundGetpackingdataResponse)

    async def get_process_order_lists(
        self,
        type: int = None,
        wid: str = None,
        process_sn: str = None,
    ...
    async def get_storage_adjust_order_list(
        self,
        search_date_type: int = None,
        start_date: str = None,
        end_date: str = None,
        order_sn: str = None,
        adjust_status: int = None,
        wid: str = None,
        type: int = None,
        page: int = None,
        page_size: int = None,
    ) -> list[GetStorageAdjustOrderListItem]:
        """查询调整单列表.
    ...
    async def get_storage_allocation_list(
        self,
        wid: str = None,
        to_wid: str = None,
        search_date_type: int = None,
        ...
        page: int = None,
        page_size: int = None,
    ) -> list[InventoryreceiptStorageallocationGetstorageallocationlistResponse]:
        """查询调拨单列表.
    ...
    async def inbound_batches_receipt(self, overseas_order_no: str = None, product_list: list = None) -> dict:
        ...
        Args:
            ...
            product_list: 产品信息 (required), array."""
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/batchesReceipt",
            {
                k: v
                for k, v in {"overseas_order_no": overseas_order_no, "product_list": product_list}.items()
                if v is not None
            },
        )
        return resp.data or {}
    ...
    async def inbound_complete_receipt(self, overseas_order_no: str = None) -> list | dict:
        ...
        Args:
            overseas_order_no: 备货单号 (required), string."""
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/completeReceipt",
            {k: v for k, v in {"overseas_order_no": overseas_order_no}.items() if v is not None},
        )
        if isinstance(resp.data, list):
            return resp.data
    ...
    async def inbound_get_custom_types(self, **kwargs: Any) -> tuple[list[InboundGetCustomTypesItem], int]:
        """获取自定义入库类型.
    ...
    async def inventory_bin_details(
        self, wid: str = None, bin_type_list: str = None, offset: int = None, length: int = None
    ) -> list[InventoryBinDetailsItem]:
        """查询仓位库存明细.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"wid": wid, "bin_type_list": bin_type_list, "offset": offset, "length": length}.items()
                if v is not None
            },
        )
    ...
    async def list_inbound(
        ...
        r_wid: list = None,
        overseas_order_no: str = None,
        create_time_from: str = None,
        create_time_to: str = None,
        page_size: int = None,
        page: int = None,
        date_type: str = None,
        is_delete: int = None,
    ) -> list[OwmsInboundListinboundResponse]:
        """查询海外仓备货单列表.
    ...
    async def list_order_nos(self, inbound_order_no: list = None) -> list[OwmsInboundListordernosResponse]:
        ...
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/listOrderNos",
            {k: v for k, v in {"inbound_order_no": inbound_order_no}.items() if v is not None},
        )
        return self._parse_list(resp.data, OwmsInboundListordernosResponse)

    async def match_sku_list(
        self, wid: str = None, is_matched: int = None, offset: int = None, length: int = None
    ) -> list[OwmsInboundMatchskulistResponse]:
        """查询系统产品与第三方海外仓产品映射列表.
        ...
        Args:
            ...
            length: 分页长度，默认20, int."""
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/matchSkuList",
            {
                k: v
                for k, v in {"wid": wid, "is_matched": is_matched, "offset": offset, "length": length}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, OwmsInboundMatchskulistResponse)

    async def outbound_get_custom_types(self, **kwargs: Any) -> tuple[list[OutboundGetCustomTypesItem], int]:
        """获取自定义出库类型.
    ...
    async def outbound_order_delete(self, orderSn: list = None) -> OutboundorderOutboundDeleteResponse | None:
        ...
        Args:
            orderSn: 出库单单号, array."""
        resp = await self._post(
            "/basicOpen/outboundOrder/outbound/delete", {k: v for k, v in {"orderSn": orderSn}.items() if v is not None}
        )
        return self._parse_one(resp.data, OutboundorderOutboundDeleteResponse)

    async def outboundget_orders(
        self,
        offset: int = None,
        length: int = None,
        wid: str = None,
    ...
    async def oversea_stock_order_allocate(self, orderNo: str = None) -> dict:
        ...
        resp = await self._post(
            "/basicOpen/overSeaWarehouse/stockOrder/allocate",
            {k: v for k, v in {"orderNo": orderNo}.items() if v is not None},
        )
        return resp.data or {}

    async def package_label(
        self, size: int = None, overseas_order_no: str = None
    ) -> list[OwmsInboundPackagelabelResponse]:
        """获取第三方箱唛.
        ...
        Args:
            ...
            overseas_order_no: 备货单号 (required), string."""
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/packageLabel",
            {k: v for k, v in {"size": size, "overseas_order_no": overseas_order_no}.items() if v is not None},
        )
        return self._parse_list(resp.data, OwmsInboundPackagelabelResponse)

    async def packing(
        self, overseas_order_no: str = None, packaging_type: int = None, box_count: int = None, box_list: list = None
    ) -> list | dict:
        """上传备货单装箱信息.
        ...
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/packing",
            {
                k: v
                for k, v in {
                    "overseas_order_no": overseas_order_no,
    ...
    async def partly_receive_allocation_order(self, **kwargs: Any) -> dict:
        """写操作 partlyReceiveAllocationOrder. POST /erp/sc/routing/inventoryReceipt/StorageAllocation/partlyReceiveAllocationOrder"""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAllocation/partlyReceiveAllocationOrder",
            kwargs if kwargs else None,
        )
        return resp.data or {}

    async def product_label(self, **kwargs: Any) -> list | dict:
        """获取第三方SKU标签PDF文件.
    ...
    async def quality_inspection_order_detail(self, **kwargs: Any) -> list[QualityinspectionorderDetailResponse]:
        """查询质检单详情.
    ...
    async def receive_allocation_order(self, orderSnMany: str = None) -> dict:
        ...
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAllocation/receiveAllocationOrder",
            {k: v for k, v in {"orderSnMany": orderSnMany}.items() if v is not None},
        )
        return resp.data or {}

    async def removal_inbound_list(
        self,
        status: int = None,
        start_date: str = None,
        end_date: str = None,
        ...
        resp = await self._post(
            "/erp/sc/routing/owms/removalInbound/list",
            {
                k: v
                for k, v in {
                    "status": status,
    ...
    async def set_tracking_no(
        ...
        logistics_freight: str = None,
        logistics_freight_currency_code: str = None,
        pkg_fee_weight: str = None,
        pkg_fee_weight_unit: str = None,
    ) -> dict:
        """物流下单 - 编辑运单号/跟踪号.
        ...
        resp = await self._post(
            "/basicOpen/logisticsOrdering/setTrackingNo",
            {
                k: v
                for k, v in {
    ...
    async def submit_allocation_order(
        self,
        sys_wid: int = None,
        sys_to_wid: int = None,
        freight_fee: str = None,
        ...
        out_bin_type: str = None,
        product_list: list = None,
    ) -> InventoryreceiptStorageallocationSubmitallocationorderResponse | None:
        """创建待调拨的调拨单.
        ...
        Args:
            ...
            product_list: 产品明细 (required), array."""
        resp = await self._post(
            "/erp/sc/routing/inventoryReceipt/StorageAllocation/submitAllocationOrder",
            {
                k: v
                for k, v in {
                    "sys_wid": sys_wid,
    ...
    async def switch_status(
        self, wid: str = None, whbCode: str = None, status: int = None
    ) -> StorageWarehousebinSwitchstatusResponse | None:
        """启用、禁用仓位.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/wareHouseBin/switchStatus",
            {k: v for k, v in {"wid": wid, "whbCode": whbCode, "status": status}.items() if v is not None},
        )
    ...
    async def update_inbound(
        ...
        resp = await self._post(
            "/erp/sc/routing/owms/inbound/updateInbound",
            {
                k: v
                for k, v in {
                    "overseas_order_no": overseas_order_no,
    ...
    async def ware_house_bin_statement(
        self,
        wid: str = None,
        type: str = None,
        bin_type_list: str = None,
        start_date: str = None,
        end_date: str = None,
        offset: int = None,
        length: int = None,
    ) -> list[WareHouseBinStatementItem]:
        """查询仓位流水.
    ...
    async def warehouse_bin(
        ...
        offset: int = None,
        limit: int = None,
    ) -> list[LocalInventoryWarehousebinResponse]:
        """查询本地仓位列表.
    ...
    async def wms_order_get_wms_logistics_labels(
        self, wo_number_arr: list = None, order_number_arr: list = None
    ) -> list[WmsOrderGetwmslogisticslabelsResponse]:
        """查询销售出库单物流面单.
        ...
        resp = await self._post(
            "/erp/sc/routing/wms/order/getWmsLogisticsLabels",
            {
                k: v
                for k, v in {"wo_number_arr": wo_number_arr, "order_number_arr": order_number_arr}.items()
                if v is not None
            },
        )
