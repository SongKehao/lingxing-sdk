...
class FinanceEndpoints(BaseEndpoint):
    ...
    async def fee_management_other_fee_type(
        self, offset: int = None, length: int = None
    ) -> list[FeeManagementOtherFeeTypeResponse]:
        """查询费用类型列表.
    ...
    async def settlement_profit_list(
        self,
        summary_field: int = None,
        summary_type: int = None,
        page_num: int = None,
        page_size: int = None,
        start_date: str = None,
        end_date: str = None,
        date_range_type: int = None,
        sids: list = None,
        ...
        currency: str = None,
    ) -> list[SettlementProfitListResponse]:
        """查询利润报表-明细列表.
        ...
        Args:
            ...
            currency: 币种, string."""
        resp = await self._post(
            "/basicOpen/finance/settlement/profitList",
            {
                k: v
                for k, v in {
    ...
    async def fiance_profit_msku(
        self, offset: int = None, length: int = None, currency_type: int = None, sids: str = None, month: str = None
    ) -> list[FinanceProfitstateProfitmskuResponse]:
        """查询利润报表（旧） - MSKU.
        ...
        resp = await self._post(
            "/erp/sc/routing/finance/ProfitState/profitMsku",
            {
                k: v
                for k, v in {
                    "offset": offset,
    ...
    async def order_profit_list_msku(
        self,
        offset: int = None,
        length: int = None,
        sids: list = None,
    ...
    ) -> list[FinanceMreportOrderprofitResponse]:
        """查询订单利润-MSKU.
    ...
    async def query_receipt_funds_list(
        self,
        endDate: str = None,
        length: int = None,
        offset: int = None,
        searchField: str = None,
        searchFieldTime: str = None,
        searchValue: str = None,
        seniorSearchList: str = None,
        startDate: str = None,
        status: list = None,
    ) -> list[FinanceQueryreceiptfundslistResponse]:
        """查询收款单列表.
        ...
        resp = await self._post(
            "/basicOpen/finance/queryReceiptFundsList",
            {
                k: v
                for k, v in {
                    "endDate": endDate,
                    ...
                    "searchValue": searchValue,
                    "seniorSearchList": seniorSearchList,
                    "startDate": startDate,
                    "status": status,
                }.items()
                if v is not None
    ...
    async def request_funds_order_list(
        self,
        offset: int = None,
        length: int = None,
        status: int = None,
    ...
    ) -> list[RequestfundsOrderListResponse]:
        """查询请款单列表.
    ...
    async def lazada_payout_list(
        self,
        compareLogic: str = None,
        currencyCode: str = None,
        endDate: str = None,
        envKey: str = None,
        exportFields: list = None,
        fieldCompares: list = None,
        hasDifference: bool = None,
        length: float = None,
        offset: float = None,
        paid: float = None,
        platformCode: str = None,
        searchExactly: bool = None,
        searchMultiValue: list = None,
        ...
        sortType: str = None,
        startDate: str = None,
        storeTypes: list = None,
        timeType: float = None,
    ) -> list[LazadaPayoutListResponse]:
        """回款明细-LazadaPayout.
        ...
        resp = await self._post(
            "/basicOpen/finance/lazada/payout/list",
            {
                k: v
                for k, v in {
                    ...
                    "fieldCompares": fieldCompares,
                    "hasDifference": hasDifference,
                    "length": length,
                    "offset": offset,
                    "paid": paid,
                    "platformCode": platformCode,
                    "searchExactly": searchExactly,
    ...
    async def lazada_settlement_list(
        self,
        compareLogic: str = None,
        currencyCode: str = None,
        endDate: str = None,
        ...
        feeNames: list = None,
        fieldCompares: list = None,
        isInSettlement: float = None,
        length: float = None,
        offset: float = None,
        paidStatuses: list = None,
        platformCode: str = None,
        searchExactly: bool = None,
        searchExactly1: bool = None,
        searchMultiValue: list = None,
        searchMultiValue1: list = None,
        searchSingleValue: str = None,
        searchSingleValue1: str = None,
        searchType: float = None,
        searchType1: float = None,
        sids: list = None,
        sites: list = None,
        sortField: str = None,
        sortType: str = None,
    ...
    ) -> list[LazadaSettlementListResponse]:
        ...
        resp = await self._post(
            "/basicOpen/finance/lazada/settlement/list",
            {
                k: v
                for k, v in {
                    "compareLogic": compareLogic,
                    ...
                    "platformCode": platformCode,
                    "searchExactly": searchExactly,
                    "searchExactly1": searchExactly1,
                    "searchMultiValue": searchMultiValue,
                    "searchMultiValue1": searchMultiValue1,
                    "searchSingleValue": searchSingleValue,
                    "searchSingleValue1": searchSingleValue1,
                    "searchType": searchType,
    ...
    async def profit_asin(
        self, month: str = None, sids: str = None, currency_type: str = None, offset: int = None, length: int = None
    ) -> list[FinanceProfitstateProfitasinResponse]:
        """查询利润报表（旧） - ASIN（父级）.
        ...
        resp = await self._post(
            "/erp/sc/routing/finance/ProfitState/profitAsin",
            {
                k: v
                for k, v in {
                    "month": month,
    ...
    async def profit_asin_son(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[FinanceProfitstateProfitasinsonResponse]:
        """查询利润报表（旧） - ASIN（子级）.
        ...
        Args:
            ...
            length: 分页长度 (required), int."""
        resp = await self._post(
            "/erp/sc/routing/finance/ProfitState/profitAsinSon",
            {
                k: v
                for k, v in {
                    "month": month,
    ...
    async def profit_report_order_transcation_list(
        self,
        offset: int = None,
        length: int = None,
        mids: list = None,
        ...
        startDate: str = None,
        endDate: str = None,
        gmtModifiedStartDate: str = None,
        gmtModifiedEndDate: str = None,
        currencyCode: str = None,
        searchField: str = None,
        searchValue: list = None,
        sortField: str = None,
        sortType: str = None,
        settlementStatus: list = None,
        fundTransferStatus: list = None,
        accountType: list = None,
        eventSource: list = None,
        fulfillment: list = None,
        principalUids: list = None,
        productDeveloperUids: list = None,
        orderStatus: str = None,
    ) -> list[OrderTranscationListResponse]:
    ...
    async def profit_settlement(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[FinanceProfitstateProfitsettlementResponse]:
        """查询利润报表（旧）-结算明细.
        ...
        Args:
            ...
            length: 分页长度 (required), int."""
        resp = await self._post(
            "/erp/sc/routing/finance/ProfitState/profitSettlement",
            {
                k: v
                for k, v in {
                    "sids": sids,
    ...
    async def request_funds_pool_custom_fee_list(
        self,
        offset: int = None,
        length: int = None,
        pay_status: str = None,
        ...
        search_field: str = None,
        search_value: str = None,
    ) -> list[RequestfundspoolCustomfeeListResponse]:
        """查询请款池-其他应付款.
    ...
    async def request_funds_pool_inbound_list(
        self,
        pay_status: str = None,
        time_field: str = None,
        start_time: str = None,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[RequestfundspoolInboundListResponse]:
        """查询请款池 - 货款月结.
    ...
    async def request_funds_pool_logistics_list(
        self,
        offset: int = None,
        length: int = None,
        search_field_time: str = None,
        ...
        search_field: str = None,
        search_value: str = None,
    ) -> list[RequestfundspoolLogisticsListResponse]:
        """查询请款池-物流请款.
    ...
    async def request_funds_pool_other_fee_list(
        self,
        endTime: str = None,
        startTime: str = None,
        length: int = None,
        offset: int = None,
        purchaserIds: list = None,
        searchField: str = None,
        searchFieldTime: str = None,
        searchValue: str = None,
        status: int = None,
        supplierIds: list = None,
    ) -> list[RequestfundspoolOtherfeeListResponse]:
        """查询请款池-其他费用.
    ...
    async def request_funds_pool_prepay_list(
        self,
        offset: int = None,
        length: int = None,
        pay_status: str = None,
        ...
        search_field: str = None,
        search_value: str = None,
    ) -> list[RequestfundspoolPrepayListResponse]:
        """查询请款池 - 货款预付款.
    ...
    async def request_funds_pool_purchase_list(
        self,
        pay_status: str = None,
        time_field: str = None,
        start_time: str = None,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[RequestfundspoolPurchaseListResponse]:
        """查询请款池 - 货款现结.
    ...
    async def shopee_adjustment_list(
        self,
        adjDimensions: list = None,
        adjTypes: list = None,
        compareLogic: str = None,
        currencyCode: str = None,
        endDate: str = None,
        ...
        startDate: str = None,
        storeTypes: list = None,
    ) -> list[ShopeeAdjustmentListResponse]:
        ...
        resp = await self._post(
            "/basicOpen/finance/shopee/adjustment/list",
            {
                k: v
                for k, v in {
                    "adjDimensions": adjDimensions,
                    "adjTypes": adjTypes,
                    "compareLogic": compareLogic,
                    "currencyCode": currencyCode,
                    "endDate": endDate,
    ...
    async def shopee_income_list(
        self,
        compareLogic: str = None,
        currencyCode: str = None,
        endDate: str = None,
        envKey: str = None,
        expandChildren: bool = None,
        exportFields: list = None,
        fieldCompares: list = None,
        length: float = None,
        offset: float = None,
        ...
        Args:
            ...
            storeTypes: 店铺类型数组： `1` 跨境店(CB) `2` 本土店(Local), array."""
        resp = await self._post(
            "/basicOpen/finance/shopee/income/list",
            {
                k: v
                for k, v in {
                    "compareLogic": compareLogic,
    ...
    async def shopee_payout_list(
        ...
        sortType: str = None,
        startDate: str = None,
        storeType: float = None,
    ) -> list[ShopeePayoutListResponse]:
        """回款明细-ShopeePayout.
        ...
        resp = await self._post(
            "/basicOpen/finance/shopee/payout/list",
            {
                k: v
                for k, v in {
                    "compareLogic": compareLogic,
    ...
    async def fee_management_list(
        ...
        end_date: str,
        sids: list = None,
        other_fee_type_ids: list = None,
        status_order: int = None,
        dimensions: list = None,
        apportion_status: list = None,
        status_merge: int = None,
        search_field: str = None,
        search_value: str = None,
    ) -> list[FeemanagementOtherfeeListResponse]:
        """查询费用明细列表.
        ...
        resp = await self._post(
            "/bd/fee/management/open/feeManagement/otherFee/list",
            {
                ...
                for k, v in {
                    ...
                    "apportion_status": apportion_status,
    ...
    async def fee_management_create(
        self, submit_type: int, dimension: int, apportion_rule: int, is_request_pool: int, remark: str, fee_items: list
    ) -> list[FeemanagementOtherfeeListResponse]:
        """创建费用单.
    ...
    async def fee_management_edit(
        ...
        Args:
            ...
            remark: 单据备注, str."""
        resp = await self._post(
            "/bd/fee/management/open/feeManagement/otherFee/edit",
            {
                k: v
                for k, v in {
                    "id": id,
    ...
    async def fee_management_discard(self, numbers: list) -> list[FeemanagementOtherfeeListResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"numbers": numbers}.items() if v is not None},
        )
        return self._parse_list(resp.data, FeemanagementOtherfeeListResponse)
    ...
    async def fee_management_delete(self, numbers: list) -> list[FeemanagementOtherfeeListResponse]:
        ...
        Args:
            numbers: 费用单号，上限200, list."""
        resp = await self._post(
            "/bd/fee/management/open/feeManagement/otherFee/delete",
            {k: v for k, v in {"numbers": numbers}.items() if v is not None},
        )
        return self._parse_list(resp.data, FeemanagementOtherfeeListResponse)

    async def bd_profit_msku(
        self,
        startDate: str,
        endDate: str,
        offset: int = None,
        ...
        mids: list = None,
        sids: list = None,
        monthlyQuery: bool = None,
        searchField: str = None,
        searchValue: list = None,
        currencyCode: str = None,
        summaryEnabled: bool = None,
        orderStatus: str = None,
    ) -> list[ReportMskuListResponse]:
        """查询利润报表-MSKU.
    ...
    async def bd_profit_parent_asin(
        self,
        startDate: str,
        endDate: str,
        offset: int = None,
    ...
    async def bd_profit_seller_summary(
        self,
        startDate: str,
        endDate: str,
        mids: list = None,
        ...
        currencyCode: str = None,
        orderStatus: str = None,
    ) -> list[SellerSummaryListResponse]:
        """查询利润报表-店铺月度汇总.
    ...
    async def bd_profit_order(
        self,
        search_date_field: str,
        start_date: str,
        end_date: str,
        offset: int = None,
        length: int = None,
        ...
        settlement_status: list = None,
        fund_transfer_status: list = None,
        event_source: list = None,
        description: list = None,
    ) -> list[ReportOrderListResponse]:
        """查询利润报表-订单.
    ...
    async def settlement_summary_list(
        self,
        offset: int = None,
        length: int = None,
        ...
        searchField: str = None,
        searchValue: str = None,
    ) -> list[SettlementSummaryListResponse]:
        """查询结算中心 - 结算汇总.
        ...
        Args:
            offset: 分页偏移量, int.
            length: 分页长度, int.
            countryCodes: 国家，查询亚马逊市场列表接口对应字段mid, list.
            sids: 店铺id ，对应查询亚马逊店铺列表接口对应字段【sid】, list.
            currencyCode: 币种, str.
            dateType: 时间类型： 0 结算开始时间 1 结算结束时间 2 转账时间, int.
            startDate: 开始时间【时间间隔最长不得超过90天】, str.
            endDate: 结束时间【时间间隔最长不得超过90天】, str.
            searchField: 搜索字段：  id 结算编号 settlement_id 账单编号, str.
            searchValue: 搜索值, str."""
        resp = await self._post(
    ...
    async def settlement_transaction_list(
        self,
        offset: int = None,
        length: int = None,
        countryCodes: list = None,
        ...
        searchField: str = None,
        searchValue: list = None,
        gmtModifiedStart: str = None,
        gmtModifiedEnd: str = None,
    ) -> list[TransactionDetailListResponse]:
        """查询结算中心 - 交易明细.
    ...
    async def settle_detail_query(
        ...
        Args:
            ...
            length: 分页长度，默认20，上限1000, int."""
        resp = await self._post(
            "/bd/profit/report/open/report/settle/compute/manual",
            {
                k: v
                for k, v in {
                    "sellerIds": sellerIds,
    ...
    async def summary_query(
        ...
        Args:
            ...
            length: 分页长度，默认20，上限1000, int."""
        resp = await self._post(
            "/bd/profit/report/open/report/summary/query",
            {
                k: v
                for k, v in {
                    "sellerIds": sellerIds,
    ...
    async def settlement_report(
        self,
        amazonSellerIds: list,
        sids: list,
        timeType: str,
        filterBeginDate: str,
        filterEndDate: str,
        countryCodes: list = None,
        orderNumbers: list = None,
        shipmentNumbers: list = None,
        customNumbers: list = None,
        mskus: list = None,
        skus: list = None,
        productNames: list = None,
        trackCodes: list = None,
        ...
        Args:
            ...
            length: 分页长度，默认20，上限1000, int."""
        resp = await self._post(
            "/bd/sp/api/open/settlement/report",
            {
                k: v
                for k, v in {
    ...
    async def settlement_export_url_get(
        self, seller_id: str = None, financial_event_group_id: str = None
    ) -> list | dict:
        """查询settlement下载URL.
        ...
        Args:
            seller_id: 亚马逊店铺id ,对应查询亚马逊店铺列表接口对应字段【seller_id】, str.
            financial_event_group_id: 结算汇总财务事件组ID【结算汇总->financialEventGroupId】, str."""
        resp = await self._post(
            "/bd/sp/api/open/settlement/export/url/get",
            {
                k: v
                for k, v in {"seller_id": seller_id, "financial_event_group_id": financial_event_group_id}.items()
                if v is not None
            },
        )
        if isinstance(resp.data, list):
    ...
    async def cost_stream(
        ...
        end_date: str,
        wh_names: list = None,
        shop_names: list = None,
        skus: list = None,
        mskus: list = None,
        disposition_types: list = None,
        business_numbers: list = None,
        origin_accounts: list = None,
        offset: int = None,
        length: int = None,
    ) -> list | dict:
        """查询FBA成本计价流水.
        ...
        resp = await self._post(
            "/bd/profit/report/open/report/cost/stream",
            {
                k: v
                for k, v in {
    ...
    async def invoice_list(
        ...
        Args:
            ...
            search_value: 搜索值, str."""
        resp = await self._post(
            "/bd/profit/report/open/report/invoice/list",
            {
                k: v
                for k, v in {
    ...
    async def invoice_campaign_list(
        self,
        invoice_id: str,
        sid: int,
        offset: int = None,
        ...
        Args:
            ...
            search_value: 搜索值, str."""
        resp = await self._post(
            "/bd/profit/report/open/report/invoice/campaign/list",
            {
                k: v
                for k, v in {
    ...
    async def invoice_detail(self, invoice_id: str, sid: int) -> list | dict:
        ...
        Args:
            ...
            sid: 店铺id ，对应查询亚马逊店铺列表接口对应字段【sid】, int."""
        resp = await self._post(
            "/bd/profit/report/open/report/invoice/detail",
            {k: v for k, v in {"invoice_id": invoice_id, "sid": sid}.items() if v is not None},
        )
        if isinstance(resp.data, list):
            return resp.data
        return resp.data or {}
    ...
    async def compute_manual(self, date_month: str) -> list | dict:
        ...
        resp = await self._post(
            "/bd/profit/report/open/report/settle/compute/manual",
            {k: v for k, v in {"date_month": date_month}.items() if v is not None},
        )
        if isinstance(resp.data, list):
            return resp.data
        return resp.data or {}

    async def receivable_report_list(
        self,
        settleMonth: str,
        sids: list = None,
        mids: list = None,
        currencyCode: str = None,
        archiveStatus: int = None,
        sortField: str = None,
        sortType: str = None,
        receivedState: int = None,
        offset: int = None,
        length: int = None,
    ) -> list[ReceivableReportListResponse]:
        """应收报告-列表查询.
    ...
    async def reportlistdetailinfo(
        self, sid: int, currencyCode: str, settleMonth: str
    ) -> list[ReceivableReportListResponse]:
        """应收报告-详情-基础信息.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"sid": sid, "currencyCode": currencyCode, "settleMonth": settleMonth}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, ReceivableReportListResponse)
