...
class VCEndpoints(BaseEndpoint):
    ...
    async def listing_manage_vc_listing_page_list(
        self, offset: int = None, length: int = None, vc_store_ids: list = None
    ) -> list[ListingmanageVclistingPagelistResponse]:
        """查询Listing列表.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"offset": offset, "length": length, "vc_store_ids": vc_store_ids}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, ListingmanageVclistingPagelistResponse)

    async def platform_auth_vc_seller_page_list(
        self, offset: int = None, length: int = None
    ) -> list[PlatformauthVcsellerPagelistResponse]:
        """查询VC店铺列表.
    ...
    async def vc_deliver_detail(self, orderNo: str = None) -> list[GetinvoiceDetailResponse]:
        ...
        resp = await self._post(
            "/basicOpen/openapi/getInvoice/detail", {k: v for k, v in {"orderNo": orderNo}.items() if v is not None}
        )
        return self._parse_list(resp.data, GetinvoiceDetailResponse)

    async def vc_deliver_page_list(
        self,
        offset: float = None,
        length: float = None,
        sids: list = None,
        ...
        status: float = None,
        createTimeStartTime: str = None,
        createTimeEndTime: str = None,
        shipmentTimeStartTime: str = None,
        shipmentTimeEndTime: str = None,
    ) -> list[GetinvoicePageListResponse]:
        """查询VC发货单列表.
    ...
    async def vc_order_df_confirm_shipment(
        self, ids: list = None
    ) -> PlatformorderVcorderdfConfirmshipmentResponse | None:
        """VC订单-确认发货【DF】.
        ...
        resp = await self._post(
            "/basicOpen/platformOrder/vcOrderDf/confirmShipment",
            {k: v for k, v in {"ids": ids}.items() if v is not None},
        )
        return self._parse_one(resp.data, PlatformorderVcorderdfConfirmshipmentResponse)

    async def vc_order_df_detail(
        self, vc_store_id: str = None, purchase_order_number: str = None
    ) -> list[PlatformorderVcorderdfDetailResponse]:
        """查询VC订单详情【DF】.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"vc_store_id": vc_store_id, "purchase_order_number": purchase_order_number}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, PlatformorderVcorderdfDetailResponse)

    async def vc_order_df_get_shipping_label(
        self, ids: list = None
    ) -> list[PlatformorderVcorderdfGetshippinglabelResponse]:
        """VC订单-打印标签【DF】.
        ...
        Args:
            ids: 订单ID，查询VC订单列表接口对应字段【id】 (required), array."""
        resp = await self._post(
            "/basicOpen/platformOrder/vcOrderDf/getShippingLabel",
            {k: v for k, v in {"ids": ids}.items() if v is not None},
        )
        return self._parse_list(resp.data, PlatformorderVcorderdfGetshippinglabelResponse)

    async def vc_order_df_submit_shipping_label(
        self, ids: list = None
    ) -> PlatformorderVcorderdfSubmitsshippinglabelResponse | None:
        """VC订单-请求标签【DF】.
        ...
        Args:
            ids: 订单ID，查询VC订单列表接口对应字段【id】 (required), array."""
        resp = await self._post(
            "/basicOpen/platformOrder/vcOrderDf/submitShippingLabel",
            {k: v for k, v in {"ids": ids}.items() if v is not None},
        )
        return self._parse_one(resp.data, PlatformorderVcorderdfSubmitsshippinglabelResponse)

    async def vc_order_page_list(
        self,
        purchase_order_type: list = None,
        offset: int = None,
        length: int = None,
        vc_store_ids: list = None,
        search_field_time: str = None,
        start_date: str = None,
        end_date: str = None,
        search_field: str = None,
        search_value: list = None,
    ) -> list[PlatformorderVcorderPagelistResponse]:
        """查询VC订单列表.
    ...
    async def vc_order_po_detail(self, local_po_number: str = None) -> list[PlatformorderVcorderpoDetailResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"local_po_number": local_po_number}.items() if v is not None},
        )
