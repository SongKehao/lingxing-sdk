...
class FBAEndpoints(BaseEndpoint):
    ...
    async def fba_plan_allocate_storage(
        self, data: FbaPlanAllocateStorageReq | None = None
    ) -> FbaPlanAllocateStorageResponse | None:
        """FBA仓发货计划锁库存.
    ...
    async def fba_plan_release_storage(
        self, data: FbaPlanReleaseStorageReq | None = None
    ) -> FbaPlanReleaseStorageResponse | None:
        """FBA仓发货计划释放库存.
    ...
    async def sta_create_inbound_plan(
        self, data: StaCreateInboundPlanReq | None = None
    ) -> StaCreateInboundPlanResponse | None:
        """创建STA任务.
    ...
    async def sta_list_packing_group(
        self, inbound_plan_id: str = None, sid: int = None
    ) -> list[StaListPackingGroupResponse]:
        """查询包装组.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"inboundPlanId": inbound_plan_id, "sid": sid}.items() if v is not None},
        )
        return self._parse_list(resp.data, StaListPackingGroupResponse)

    async def sta_save_local_packing(
        self, data: StaSaveLocalPackingReq | None = None
    ) -> StaSaveLocalPackingResponse | None:
        """保存装箱信息.
    ...
    async def sta_set_packing(self, data: StaSetPackingReq | None = None) -> StaSetPackingResponse | None:
        """提交装箱信息.
    ...
    async def sta_generate_placement(
        self, data: StaGeneratePlacementReq | None = None
    ) -> StaGeneratePlacementResponse | None:
        """生成货件方案.
    ...
    async def sta_shipment_preview(
        self, inbound_plan_id: str = None, sid: int = None
    ) -> list[StaShipmentPreviewResponse]:
        """查询货件方案.
    ...
    async def sta_get_packing_box_info(
        self, inbound_plan_id: str = None, sid: int = None
    ) -> list[StaGetPackingBoxInfoResponse]:
        """查询货件方案的装箱信息.
    ...
    async def sta_confirm_placement(
        self, data: StaConfirmPlacementReq | None = None
    ) -> StaConfirmPlacementResponse | None:
        """确认货件方案.
    ...
    async def sta_generate_transport(
        self, data: StaGenerateTransportReq | None = None
    ) -> StaGenerateTransportResponse | None:
        """生成承运方式.
    ...
    async def sta_generate_delivery_date(
        self, data: StaGenerateDeliveryDateReq | None = None
    ) -> StaGenerateDeliveryDateResponse | None:
        """生成可选送达时间.
    ...
    async def sta_get_transport(
        self, inbound_plan_id: str = None, shipment_id: str = None, sid: int = None
    ) -> list[StaGetTransportResponse]:
        """查询承运方式.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"inboundPlanId": inbound_plan_id, "shipmentId": shipment_id, "sid": sid}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, StaGetTransportResponse)

    async def sta_get_delivery_date(
        self, inbound_plan_id: str = None, shipment_id: str = None, sid: int = None
    ) -> list[StaGetDeliveryDateResponse]:
        """查询可选送达时间.
    ...
    async def sta_commit_deliver_time(
        self, data: StaCommitDeliverTimeReq | None = None
    ) -> StaCommitDeliverTimeResponse | None:
        """提交送达时间.
    ...
    async def sta_set_delivery_service(
        self, data: StaSetDeliveryServiceReq | None = None
    ) -> StaSetDeliveryServiceResponse | None:
        """提交货件配送服务.
    ...
    async def sta_update_shipment_packing(
        self, data: StaUpdateShipmentPackingReq | None = None
    ) -> StaUpdateShipmentPackingResponse | None:
        """修改货件装箱信息.
    ...
    async def sta_update_shipment_track(
        self, data: StaUpdateShipmentTrackReq | None = None
    ) -> StaUpdateShipmentTrackResponse | None:
        """上传货件跟踪号.
    ...
    async def sta_cancel_inbound_plan(
        self, data: StaCancelInboundPlanReq | None = None
    ) -> StaCancelInboundPlanResponse | None:
        """取消STA任务.
    ...
    async def sta_operate(self, data: StaOperateReq | None = None) -> StaOperateResponse | None:
        """查询异步任务状态.
    ...
    async def sta_get_prep_details(self, sid: int = None, msku: str = None) -> list[StaGetPrepDetailsResponse]:
        ...
        Args:
            ...
            msku: see API doc."""
        resp = await self._post(
            "/amzStaServer/openapi/inbound-packing/getPrepDetails",
            {k: v for k, v in {"sid": sid, "msku": msku}.items() if v is not None},
        )
        return self._parse_list(resp.data, StaGetPrepDetailsResponse)

    async def sta_gather_inbound_plan(
        self, data: StaGatherInboundPlanReq | None = None
    ) -> StaGatherInboundPlanResponse | None:
        """同步STA任务到ERP.
    ...
    async def sta_detail(self, data: StaDetailReq | None = None) -> StaDetailResponse | None:
        """查询STA任务详情.
    ...
    async def sta_list_group_packing(
        self, inbound_plan_id: str = None, packing_group_id_list: list = None, sid: int = None
    ) -> list[StaListGroupPackingResponse]:
        """查询STA任务包装组装箱信息.
        ...
        Args:
            ...
            sid: see API doc."""
        resp = await self._post(
            "/amzStaServer/openapi/inbound-plan/listInboundPlanGroupPacking",
            {
                k: v
                for k, v in {
                    "inboundPlanId": inbound_plan_id,
                    "packingGroupIdList": packing_group_id_list,
                    "sid": sid,
                }.items()
                if v is not None
            },
    ...
    async def box_info(self, sid: int = None, shipment_id: str = None) -> list[FbaShipmentBoxinfoResponse]:
        ...
        resp = await self._post(
            "/erp/sc/routing/fba/shipment/boxInfo",
            {k: v for k, v in {"sid": sid, "shipment_id": shipment_id}.items() if v is not None},
        )
        return self._parse_list(resp.data, FbaShipmentBoxinfoResponse)

    async def create_sended_order(
        self,
        wid: int = None,
        sys_wid: int = None,
        ...
        actual_shipment_time: str = None,
        head_fee_type: int = None,
        tax_fee_type: int = None,
        is_points_behind: int = None,
        points_behind_coeffient: int = None,
        logistics_channel_id: int = None,
        is_related: int = None,
        request_flag: str = None,
        ship_mode: int = None,
        hand_pick_purchase: int = None,
        remark: str = None,
        box_type: str = None,
        box_remark: str = None,
        ...
        box_list: list = None,
        head_logistics_list: list = None,
        logistics_list: list = None,
    ) -> StorageShipmentCreatesendedorderResponse | None:
        """生成已发货的发货单.
        ...
        resp = await self._post(
            "/erp/sc/storage/shipment/createSendedOrder",
            {
                k: v
                for k, v in {
                    "wid": wid,
    ...
    async def create_ship_from_address(
        ...
        street_detail1: str = None,
        street_detail2: str = None,
        city: str = None,
        region: str = None,
        province: str = None,
        zip_code: str = None,
        phone: str = None,
    ) -> FbaShipmentCreateshipfromaddressResponse | None:
        """地址簿-发货地址创建.
        ...
        Args:
            ...
            phone: 电话号码, string."""
        resp = await self._post(
            "/erp/sc/routing/fba/shipment/createShipFromAddress",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def create_shipment_plan(
        self, remark: str = None, product_list: list = None
    ) -> StorageShipmentCreateshipmentplanResponse | None:
        """创建FBA发货计划.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"remark": remark, "product_list": product_list}.items() if v is not None},
        )
        return self._parse_one(resp.data, StorageShipmentCreateshipmentplanResponse)

    async def fba_received_inventory(
        self,
        sid: int = None,
        event_date: str = None,
        fba_shipment_id: list = None,
        offset: int = None,
        length: int = None,
    ) -> FbaReportReceivedinventoryResponse | None:
        """查询FBA到货接收明细.
    ...
    async def fba_shipment_list(
        ...
        extra_date_field: str = None,
        start_extra_date: str = None,
        end_extra_date: str = None,
    ) -> list[FbaReportShipmentlistResponse]:
        """查询货件列表.
        ...
        resp = await self._post(
            "/erp/sc/data/fba_report/shipmentList",
            {
                ...
                for k, v in {
                    ...
                    "extra_date_field": extra_date_field,
    ...
    async def get_fba_product_list(
        self,
        sids: list = None,
        ...
        resp = await self._post(
            "/erp/sc/routing/fba/shipment/getFbaProductList",
            {
                k: v
                for k, v in {
                    "sids": sids,
    ...
    async def get_head_logistics_fee_types(self, **kwargs: Any) -> list[GetHeadLogisticsFeeTypesItem]:
        """获取发货单头程物流信息-其他费类型.
    ...
    async def get_inbound_shipment_list(
        self,
        search_value: str = None,
        search_field: str = None,
        sids: str = None,
        ...
        offset: int = None,
        length: int = None,
        is_delete: float = None,
        senior_search_list: list = None,
    ) -> tuple[list[GetInboundShipmentListItem], int]:
        """查询发货单列表.
    ...
    async def get_inbound_shipment_list_mws_detail_list(
        self, shipment_sn_arr: list = None, return_deleted: bool = None
    ) -> list[StorageShipmentGetinboundshipmentlistmwsdetaillistResponse]:
        """批量查询发货单详情.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"shipment_sn_arr": shipment_sn_arr, "return_deleted": return_deleted}.items()
                if v is not None
            },
        )
    ...
    async def get_sea_track_supplier_carriers(self, vehicle_type: str = None) -> list[GetSeaTrackSupplierCarriersItem]:
        ...
        resp = await self._post(
            "/erp/sc/routing/fba/shipment/getSeaTrackSupplierCarriers",
            {k: v for k, v in {"vehicle_type": vehicle_type}.items() if v is not None},
        )
        return self._parse_list(resp.data, GetSeaTrackSupplierCarriersItem)

    async def invalid_shipment_sn(
        self,
        shipmentNos: list = None,
        isReturnStock: int = None,
        isReturnStockAux: int = None,
        ...
        resp = await self._post(
            "/basicOpen/openapi/fbaShipment/shipmentSn/invalid",
            {
                k: v
                for k, v in {
    ...
    async def send_goods(self, shipment_nos: list = None) -> dict:
        """FBA发货单发货.
    ...
    async def ship_from_address_list(
        self,
        sid: list = None,
        search_field: str = None,
        search_value: str = None,
        offset: int = None,
        length: int = None,
    ) -> list[FbaShipmentShipfromaddresslistResponse]:
        """地址簿-发货地址列表.
        ...
        resp = await self._post(
            "/erp/sc/routing/fba/shipment/shipFromAddressList",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def shipment_lock_stock(self, shipment_nos: list = None, is_auto_batch: int = None) -> list | dict:
        """发货单分配库存.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"shipment_nos": shipment_nos, "is_auto_batch": is_auto_batch}.items() if v is not None},
        )
        if isinstance(resp.data, list):
            return resp.data
        return resp.data or {}

    async def shipment_plan_lists(
        self,
        sids: str = None,
        wid: str = None,
    ...
    async def shopping_address(self, id: int = None) -> FbashipmentShoppingaddressResponse | None:
        ...
        resp = await self._post(
            "/basicOpen/openapi/fbaShipment/shoppingAddress", {k: v for k, v in {"id": id}.items() if v is not None}
        )
        return self._parse_one(resp.data, FbashipmentShoppingaddressResponse)

    async def sync_shipment(
        self, sid: int = None, shipment_ids: list = None, sync_anyway: int = None
    ) -> FbaShipmentSyncshipmentResponse | None:
        """同步亚马逊货件到ERP.
        ...
        resp = await self._post(
            "/erp/sc/routing/fba/shipment/syncShipment",
            {
                k: v
                for k, v in {"sid": sid, "shipment_ids": shipment_ids, "sync_anyway": sync_anyway}.items()
                if v is not None
            },
        )
        return self._parse_one(resp.data, FbaShipmentSyncshipmentResponse)

    async def update_custom_cost(
        self, shipment_sn: str = None, is_custom_cost: int = None, list_field: list = None
    ) -> dict:
        """更新发货单自定义成本.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/shipment/updateCustomCost",
            {
                k: v
                for k, v in {
    ...
    async def update_plan_lists(
        self,
        order_sn: str = None,
        shipment_time: str = None,
        packing_type: int = None,
        logistics_provider_id: int = None,
        logistics_channel_id: int = None,
        shipment_plan_quantity: int = None,
        quantity_in_case: int = None,
        box_num: int = None,
        sys_wid: int = None,
        cg_package_length: float = None,
        cg_package_width: float = None,
        cg_package_height: float = None,
        cg_box_length: float = None,
        cg_box_width: float = None,
        cg_box_height: float = None,
        nw: float = None,
        gw: float = None,
        cg_box_weight: float = None,
        remark: str = None,
    ) -> dict:
        """编辑FBA发货计划.
        ...
        Args:
            ...
            remark: 备注, string."""
        resp = await self._post(
            "/erp/sc/routing/storage/shipment/updateShipmentPlan",
            {
                k: v
                for k, v in {
                    "order_sn": order_sn,
    ...
    async def update_ship_from_address(
        ...
        resp = await self._post(
            "/erp/sc/routing/fba/shipment/updateShipFromAddress",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def update_shipment_actual_status(self, is_closed: int = None, list_field: list = None) -> dict:
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/shipment/updateShipmentActualStatus",
            {k: v for k, v in {"is_closed": is_closed, "list_field": list_field}.items() if v is not None},
        )
        return resp.data or {}
    ...
    async def vc_batch_send_goods(self, orderNoList: list = None) -> GetinvoiceInvoiceBatchsendgoodsResponse | None:
        ...
        resp = await self._post(
            "/basicOpen/openapi/getInvoice/invoice/batchSendGoods",
            {k: v for k, v in {"orderNoList": orderNoList}.items() if v is not None},
        )
    ...
    async def create_ready_send_order(
        ...
        head_logistics_list: list = None,
        logistics_list: list = None,
    ) -> StorageShipmentCreatereadysendorderResponse | None:
        """生成待发货的发货单.
        ...
        Args:
            ...
            logistics_list: 旧版物流信息，即将下线, array."""
        resp = await self._post(
            "/erp/sc/routing/storage/shipment/createReadySendOrder",
            {
                k: v
                for k, v in {
                    "wid": wid,
    ...
    async def get_inbound_shipment_list_mws_detail(
        self, shipment_sn: str = None, return_deleted: bool = None
    ) -> list[StorageShipmentGetinboundshipmentlistmwsdetailResponse]:
        """查询发货单详情.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"shipment_sn": shipment_sn, "return_deleted": return_deleted}.items() if v is not None},
        )
        return self._parse_list(resp.data, StorageShipmentGetinboundshipmentlistmwsdetailResponse)

    async def outbound_order_release_stock(self, shipment_nos: list = None) -> dict:
        """发货单释放库存.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/shipment/releaseStock",
            {k: v for k, v in {"shipment_nos": shipment_nos}.items() if v is not None},
        )
        return resp.data or {}

    async def print_fba_labels(
        self,
        hide_ship_from_company_name: int = None,
        hide_ship_to_company_name: int = None,
        print_sta_name_page: int = None,
        sort_label: int = None,
        type: str = None,
        data: list = None,
    ) -> StorageShipmentPrintfbalabelsResponse | None:
        """查询FBA货件箱子、卡板标签.
        ...
        resp = await self._post(
            "/erp/sc/storage/shipment/printFbaLabels",
            {
                k: v
                for k, v in {
    ...
    async def print_fnsku_labels(
        self,
        page_type: str = None,
        print_content: str = None,
        content_type: str = None,
        print_custom: str = None,
        custom_content: str = None,
        new_tag: str = None,
        data: list = None,
    ) -> StorageShipmentPrintfnskulabelsResponse | None:
        """查询FBA货件商品FNSKU标签.
        ...
        resp = await self._post(
            "/erp/sc/storage/shipment/printFnskuLabels",
            {
                k: v
                for k, v in {
                    "page_type": page_type,
    ...
    async def search_process_result(self, request_flag: str = None) -> list[StorageShipmentSearchprocessresultResponse]:
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/shipment/searchProcessResult",
            {k: v for k, v in {"request_flag": request_flag}.items() if v is not None},
        )
        return self._parse_list(resp.data, StorageShipmentSearchprocessresultResponse)

    async def update_inbound_shipment_list_mws(
        self,
        shipment_sn: str = None,
        remark: str = None,
        box_type: str = None,
        items: list = None,
        box_list: list = None,
        ...
        Args:
            ...
            box_list: 装箱数据, array."""
        resp = await self._post(
            "/erp/sc/routing/storage/shipment/updateInboundShipmentListMws",
            {
                k: v
                for k, v in {
                    "shipment_sn": shipment_sn,
    ...
    async def update_list_logistics(self, data: list = None, head_logistics_list: list = None) -> dict:
        """更新发货单物流信息.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"data": data, "head_logistics_list": head_logistics_list}.items() if v is not None},
        )
        return resp.data or {}
