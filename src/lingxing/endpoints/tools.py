...
Args:
    ...
    async def get_keyword_list(self, mid: int = None, start_date: str = None, end_date: str = None, offset: int = None, length: int = None) -> list[ToolToolkeywordrankGetkeywordlistResponse]:
        """关键词列表.
...
Args:
    ...
    async def warning_message_inventory_list(self, offset: int = None, length: int = None, model_id_list: list = None, product_type_list: list = None, start_date: str = None, end_date: str = None, show_status: int = None) -> list[SettingsWarningmessageInventorylistResponse]:
        """查询预警消息列表-库存.
