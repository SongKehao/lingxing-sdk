...
class NewAdEndpoints(BaseEndpoint):
    ...
    async def walmart_advertiser_list(
        self, search_text: str = None, page: int = None, limit: int = None
    ) -> list[AdReportAdvertiserListResponse]:
        """查询沃尔玛-广告-广告主列表.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"searchText": search_text, "page": page, "limit": limit}.items() if v is not None},
        )
        return self._parse_list(resp.data, AdReportAdvertiserListResponse)

    async def dsp_account_list(
        self, offset: int = None, length: int = None, type: str = None
    ) -> list[BasedataAccountListResponse]:
        """查询广告账号列表.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"offset": offset, "length": length, "type": type}.items() if v is not None},
        )
        return self._parse_list(resp.data, BasedataAccountListResponse)

    async def product_analysis_list(
        self,
        profile_id: int = None,
        sid: str = None,
        sku: list = None,
        ...
        end_date: str = None,
        group_type: str = None,
        sponsored_type: list = None,
    ) -> list[AdreportProductorderanalysisListResponse]:
        """出单时段分析（产品）.
        ...
        resp = await self._post(
            "/basicOpen/adReport/productOrderAnalysis/list",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def walmart_query_advertiser_list(
        self, searchText: str = None, paging: str = None, limit: int = None, page: int = None
    ) -> list[AdreportAdvertiserListResponse]:
        """查询沃尔玛广告主列表.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"searchText": searchText, "paging": paging, "limit": limit, "page": page}.items()
                if v is not None
            },
        )
        return self._parse_list(resp.data, AdreportAdvertiserListResponse)

    async def dsp_report_order_list(
        self,
        offset: int = None,
        length: int = None,
        profile_id: str = None,
        start_date: str = None,
        end_date: str = None,
    ) -> list[DspreportOrderListResponse]:
        """查询DSP报告列表-订单.
        ...
        resp = await self._post(
            "/basicOpen/dspReport/order/list",
            {
                k: v
                for k, v in {
                    "offset": offset,
    ...
    async def spcampaignreports(
        ...
        report_date: str,
        profile_id: int = None,
        show_detail: int = None,
        offset: int = None,
        length: int = None,
    ) -> list[NewadSpcampaignreportsResponse]:
        """SP广告活动报表.
    ...
    async def campaignplacementreports(
        self,
        sid: int,
        report_date: str,
        profile_id: int = None,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSpcampaignplacementreportsResponse]:
        """SP广告位报告.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/spCampaignPlacementReports",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def spadgroupreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSpadgroupreportsResponse]:
        """SP广告组报表.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/spAdGroupReports",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def spproductadreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSpproductadreportsResponse]:
        """SP广告商品报表.
    ...
    async def spkeywordreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSpkeywordreportsResponse]:
        """SP关键词报表.
    ...
    async def sptargetreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSptargetreportsResponse]:
        """SP商品定位报表.
    ...
    async def asinreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSpasinreportsResponse]:
        """SP已购买商品报表.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/spAsinReports",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def querywordreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadQuerywordreportsResponse]:
        """SP用户搜索词报表.
    ...
    async def hsacampaignreports(
        self, sid: int, report_date: str, profile_id: int = None, offset: int = None, length: int = None
    ) -> list[NewadHsacampaignreportsResponse]:
        """SB广告活动报表.
    ...
    async def hsacampaignplacementreports(
        self, sid: int, report_date: str, profile_id: int = None, offset: int = None, length: int = None
    ) -> list[NewadHsacampaignplacementreportsResponse]:
        """SB广告活动-广告位报告.
    ...
    async def hsaadgroupreports(
        self, sid: int, report_date: str, profile_id: int = None, offset: int = None, length: int = None
    ) -> list[NewadHsaadgroupreportsResponse]:
        """SB广告组报表.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/hsaAdGroupReports",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def listhsatargetingreport(
        self,
        sid: int,
        sponsored_type: str,
        target_type: str,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadListhsatargetingreportResponse]:
        """SB广告的投放报告.
    ...
    async def hsaquerywordreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadHsaquerywordreportsResponse]:
        """SB用户搜索词报表.
    ...
    async def hsapurchasedasinreports(
        self, sid: int, report_date: str, profile_id: int = None, offset: int = None, length: int = None
    ) -> list[NewadHsapurchasedasinreportsResponse]:
        """SB广告归因于广告的购买报告.
    ...
    async def listhsakeywordplacementreport(
        self,
        sid: int,
        sponsored_type: str,
        target_type: str,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadListhsakeywordplacementreportResponse]:
        """SB关键词-广告位报告.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/listHsaKeywordPlacementReport",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def sdcampaignreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSdcampaignreportsResponse]:
        """SD广告活动报表.
    ...
    async def sdadgroupreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSdadgroupreportsResponse]:
        """SD广告组报表.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/sdAdGroupReports",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def sdproductadreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSdproductadreportsResponse]:
        """SD广告商品报表.
    ...
    async def sdtargetreports(
        self, sid: int, report_date: str, profile_id: int = None, offset: int = None, length: int = None
    ) -> list[NewadSdtargetreportsResponse]:
        """SD商品定位报表.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/sdTargetReports",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def sdasinreports(
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSdasinreportsResponse]:
        """SD已购买商品报表.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/sdAsinReports",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def sdmatchtargetreports(
        self,
        sid: int,
        report_date: str,
        profile_id: int = None,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadSdmatchtargetreportsResponse]:
        """SD匹配的目标报表.
    ...
    async def spcampaignhourdata(self, report_date: str, campaign_id: float) -> list[NewadSpcampaignhourdataResponse]:
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"report_date": report_date, "campaign_id": campaign_id}.items() if v is not None},
        )
    ...
    async def spadgrouphourdata(self, report_date: str, campaign_id: float) -> list[NewadSpadgrouphourdataResponse]:
        ...
        Args:
            ...
            campaign_id: 广告活动id, float."""
        resp = await self._post(
            "/pb/openapi/newad/spAdGroupHourData",
            {k: v for k, v in {"report_date": report_date, "campaign_id": campaign_id}.items() if v is not None},
        )
        return self._parse_list(resp.data, NewadSpadgrouphourdataResponse)

    async def spadvertisehourdata(
        self, report_date: str, campaign_id: float, agg_dimension: str
    ) -> list[NewadSpadvertisehourdataResponse]:
        """SP广告小时数据.
    ...
    async def sptargethourdata(
        self, report_date: str, campaign_id: float, agg_dimension: str
    ) -> list[NewadSptargethourdataResponse]:
        """SP投放小时数据.
        ...
        resp = await self._post(
            "/pb/openapi/newad/spTargetHourData",
            {
                k: v
                for k, v in {
                    "report_date": report_date,
    ...
    async def sbadgrouphourdata(self, report_date: str, campaign_id: float) -> list[NewadSbadgrouphourdataResponse]:
        ...
        Args:
            ...
            campaign_id: 广告活动id, float."""
        resp = await self._post(
            "/pb/openapi/newad/sbAdGroupHourData",
            {k: v for k, v in {"report_date": report_date, "campaign_id": campaign_id}.items() if v is not None},
        )
    ...
    async def sbtargethourdata(
        self, report_date: str, campaign_id: float, agg_dimension: str
    ) -> list[NewadSbtargethourdataResponse]:
        """SB投放小时数据.
        ...
        resp = await self._post(
            "/pb/openapi/newad/sbTargetHourData",
            {
                k: v
                for k, v in {
                    "report_date": report_date,
    ...
    async def sbadplacementhourdata(
        self, report_date: str, campaign_id: float
    ) -> list[NewadSbadplacementhourdataResponse]:
        """SB广告位小时数据.
        ...
        Args:
            ...
            campaign_id: 广告活动id, float."""
        resp = await self._post(
            "/pb/openapi/newad/sbAdPlacementHourData",
            {k: v for k, v in {"report_date": report_date, "campaign_id": campaign_id}.items() if v is not None},
        )
    ...
    async def sdadgrouphourdata(self, report_date: str, campaign_id: float) -> list[NewadSdadgrouphourdataResponse]:
        ...
        Args:
            ...
            campaign_id: 广告活动id, float."""
        resp = await self._post(
            "/pb/openapi/newad/sdAdGroupHourData",
            {k: v for k, v in {"report_date": report_date, "campaign_id": campaign_id}.items() if v is not None},
        )
        return self._parse_list(resp.data, NewadSdadgrouphourdataResponse)

    async def sdadvertisehourdata(
        self, report_date: str, campaign_id: float, agg_dimension: str
    ) -> list[NewadSdadvertisehourdataResponse]:
        """SD广告小时数据.
        ...
        Args:
            ...
            agg_dimension: 聚合维度: ad  广告维度 both_ad_target  广告+投放维度, str."""
        resp = await self._post(
            "/pb/openapi/newad/sdAdvertiseHourData",
            {
                k: v
                for k, v in {
                    "report_date": report_date,
    ...
    async def sdtargethourdata(
        self, report_date: str, campaign_id: float, agg_dimension: str
    ) -> list[NewadSdtargethourdataResponse]:
        """SD投放小时数据.
        ...
        resp = await self._post(
            "/pb/openapi/newad/sdTargetHourData",
            {
                k: v
                for k, v in {
                    "report_date": report_date,
    ...
    async def sbdivideasinreports(
        self, report_date: str, profile_id: int = None, offset: int = None, length: int = None, next_token: str = None
    ) -> list[NewadSbdivideasinreportsResponse]:
        """SB分摊.
        ...
        resp = await self._post(
            "/pb/openapi/newad/sbDivideAsinReports",
            {
                k: v
                for k, v in {
                    "profile_id": profile_id,
    ...
    async def portfolios(
        self, sid: int, profile_id: int = None, offset: int = None, length: int = None, next_token: str = None
    ) -> list[NewadPortfoliosResponse]:
        """广告组合.
    ...
    async def spproductads(
        ...
        length: int = None,
        next_token: str = None,
    ) -> list[NewadSpproductadsResponse]:
        """SP广告商品.
    ...
    async def spnegativetargetsorkeywords(
        self,
        sid: int,
        target_type: str,
        profile_id: int = None,
        campaign_id: float = None,
        offset: int = None,
        length: int = None,
        next_token: str = None,
    ) -> list[NewadSpnegativetargetsorkeywordsResponse]:
        """SP否定投放.
        ...
        Args:
            ...
            next_token: 分页游标，上次分页结果中的next_token (第一次分页无需填写，当next_token 和 offset同时存在时以next_token为主, str."""
        resp = await self._post(
            "/pb/openapi/newad/spNegativeTargetsOrKeywords",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def hsacampaigns(
        ...
        length: int = None,
        next_token: str = None,
    ) -> list[NewadHsacampaignsResponse]:
        """SB广告活动.
    ...
    async def hsanegativekeywords(
        ...
        length: int = None,
        next_token: str = None,
    ) -> list[NewadHsanegativekeywordsResponse]:
        """SB否定关键词.
        ...
        Args:
            ...
            next_token: 分页游标，上次分页结果中的next_token (第一次分页无需填写，当next_token 和 offset同时存在时以next_token为主, str."""
        resp = await self._post(
            "/pb/openapi/newad/hsaNegativeKeywords",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def hsanegativetargets(
        ...
        length: int = None,
        next_token: str = None,
    ) -> list[NewadHsanegativetargetsResponse]:
        """SB否定商品投放.
        ...
        Args:
            ...
            next_token: 分页游标，上次分页结果中的next_token (第一次分页无需填写，当next_token 和 offset同时存在时以next_token为主, str."""
        resp = await self._post(
            "/pb/openapi/newad/hsaNegativeTargets",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def sdproductads(
        ...
        length: int = None,
        next_token: str = None,
    ) -> list[NewadSdproductadsResponse]:
        """SD广告商品.
    ...
    async def sdnegativetargets(
        ...
        length: int = None,
        next_token: str = None,
    ) -> list[NewadSdnegativetargetsResponse]:
        """SD否定商品定位.
        ...
        Args:
            ...
            next_token: 分页游标，上次分页结果中的next_token (第一次分页无需填写，当next_token 和 offset同时存在时以next_token为主, str."""
        resp = await self._post(
            "/pb/openapi/newad/sdNegativeTargets",
            {
                k: v
                for k, v in {
                    "sid": sid,
    ...
    async def download_abareport(self, country: str, data_start_time: str) -> list[NewadAbareportResponse]:
        ...
        resp = await self._post(
            "/pb/openapi/newad/abaReport",
            {k: v for k, v in {"country": country, "data_start_time": data_start_time}.items() if v is not None},
        )
        return self._parse_list(resp.data, NewadAbareportResponse)

    async def apilogstandard(
        self,
        sid: int,
        log_source: str,
        sponsored_type: str,
        ...
        offset: int = None,
        length: int = None,
    ) -> list[NewadApilogstandardResponse]:
        """操作日志（新）.
        ...
        Args:
            ...
            length: 分页长度，默认15, int."""
        resp = await self._post(
            "/pb/openapi/newad/apiLogStandard",
            {
                k: v
                for k, v in {
                    "sid": sid,
