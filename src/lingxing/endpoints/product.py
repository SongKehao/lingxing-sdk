...
class ProductEndpoints(BaseEndpoint):
    ...
    async def product_tag_list(self, offset: int = None, length: int = None) -> list[LabelProductListResponse]:
        ...
        resp = await self._post(
            "/label/operation/v1/label/product/list",
    ...
    async def product_tag_create(self, label: str = None) -> LabelProductCreateResponse | None:
        ...
        resp = await self._post(
            "/label/operation/v1/label/product/create", {k: v for k, v in {"label": label}.items() if v is not None}
        )
        return self._parse_one(resp.data, LabelProductCreateResponse)

    async def product_tag_mark(
        self, operate_type: int = None, detail_list: list = None
    ) -> list[LabelProductMarkResponse]:
        """标记产品标签.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"type": operate_type, "detail_list": detail_list}.items() if v is not None},
        )
        return self._parse_list(resp.data, LabelProductMarkResponse)

    async def product_tag_unmark(
        self, operate_type: int = None, detail_list: list = None
    ) -> list[LabelProductUnmarklabelResponse]:
        """删除产品标签.
        ...
        Args:
            ...
            detail_list: 标签信息，上限200 (required), array."""
        resp = await self._post(
            "/label/operation/v1/label/product/unmarkLabel",
            {k: v for k, v in {"type": operate_type, "detail_list": detail_list}.items() if v is not None},
        )
        return self._parse_list(resp.data, LabelProductUnmarklabelResponse)

    async def add_commodity_code(
        self, commodity_codes: list = None, code_type: str = None
    ) -> PublishUpcAddcommoditycodeResponse | None:
        """创建UPC编码.
        ...
        resp = await self._post(
            "/listing/publish/api/upc/addCommodityCode",
            {k: v for k, v in {"commodity_codes": commodity_codes, "code_type": code_type}.items() if v is not None},
        )
    ...
    async def brand(self, offset: int = None, length: int = None) -> list[BrandItem]:
        ...
        resp = await self._post(
            "/erp/sc/data/local_inventory/brand",
            {k: v for k, v in {"offset": offset, "length": length}.items() if v is not None},
        )
        return self._parse_list(resp.data, BrandItem)

    async def category(self, offset: int = None, length: int = None, data: dict = None) -> list[CategoryItem]:
        """查询产品分类列表.
        ...
        Args:
            ...
            length: 分页长度，默认1000，上限1000, int."""
        resp = await self._post(
            "/erp/sc/routing/data/local_inventory/category",
            {k: v for k, v in {"offset": offset, "length": length, "data": data}.items() if v is not None},
        )
        return self._parse_list(resp.data, CategoryItem)

    async def get_paging_log_lists(
        self, businessId: int = None, endTime: str = None, startTime: str = None, page: int = None, size: int = None
    ) -> list[ProductGetpagingloglistsResponse]:
        """查询操作日志.
        ...
        Args:
            ...
            size: 每页大小, int."""
        resp = await self._post(
            "/basicOpen/product/getPagingLogLists",
            {
                k: v
                for k, v in {
    ...
    async def product_details(
        self, id: int = None, sku: str = None, sku_identifier: str = None
    ) -> list[LocalInventoryProductinfoResponse]:
        """查询本地产品详情.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"id": id, "sku": sku, "sku_identifier": sku_identifier}.items() if v is not None},
        )
        return self._parse_list(resp.data, LocalInventoryProductinfoResponse)

    async def product_lists(
        self,
        offset: int = None,
        length: int = None,
        ...
        sku_list: list = None,
        sku_identifier_list: list = None,
    ) -> list[ProductListsItem]:
        """查询本地产品列表.
    ...
    async def set_bundled(
        ...
        brand_id: int = None,
        brand: str = None,
        product_developer: str = None,
        product_developer_uid: int = None,
        product_duty_uids: list = None,
        is_append_product_duty: int = None,
        product_creator_uid: int = None,
        description: str = None,
        picture_list: list = None,
        group_list: list = None,
    ) -> list[StorageProductSetbundledResponse]:
        """添加 / 编辑捆绑产品.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/product/setBundled",
            {
                k: v
                for k, v in {
                    "sku": sku,
    ...
    async def set_category(self, data: list = None) -> list[StorageCategorySetResponse]:
        ...
        Args:
            data: 请求数据 (required), array."""
        resp = await self._post(
            "/erp/sc/routing/storage/category/set", {k: v for k, v in {"data": data}.items() if v is not None}
        )
    ...
    async def set_product(
        ...
        sku: str = None,
        product_name: str = None,
        sku_identifier: str = None,
        unit_process_fee: int = None,
        unit: str = None,
        category_id: int = None,
        category: str = None,
        model: str = None,
        ...
        cg_price: str = None,
        is_related: int = None,
        cg_delivery: int = None,
        cg_product_material: str = None,
        cg_product_length: str = None,
        cg_product_width: str = None,
        cg_product_height: str = None,
        cg_product_net_weight: str = None,
        cg_product_gross_weight: str = None,
        cg_package_length: str = None,
        cg_package_width: str = None,
        cg_package_height: str = None,
        cg_box_length: str = None,
        cg_box_width: str = None,
        cg_box_height: str = None,
        cg_box_weight: str = None,
        cg_box_pcs: int = None,
        bg_customs_export_name: str = None,
        bg_export_hs_code: str = None,
        bg_customs_import_name: str = None,
        currency: str = None,
        bg_customs_import_price: str = None,
        special_attr: list = None,
        picture_list: list = None,
        group_list: list = None,
        qc_standard: dict = None,
        product_logistics_list: dict = None,
        supplier_quote: list = None,
        declaration: dict = None,
        clearance: dict = None,
        aux_relation_list: list = None,
        spec_pack_list: list = None,
        custom_fields: list = None,
    ) -> list[StorageProductSetResponse]:
        """添加/编辑本地产品.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/product/set",
            {
                ...
                for k, v in {
                    ...
                    "unit_process_fee": unit_process_fee,
                    "unit": unit,
                    "category_id": category_id,
                    "category": category,
                    "model": model,
                    ...
                    "product_logistics_list": product_logistics_list,
    ...
    async def upc_list(self, offset: int = None, length: int = None) -> tuple[list[UpcListItem], int]:
        ...
        resp = await self._post(
            "/listing/publish/api/upc/upcList",
            {k: v for k, v in {"offset": offset, "length": length}.items() if v is not None},
        )
        return self._parse_page(resp.data, UpcListItem)

    async def upload_pictures(
        self, sku: str = None, picture_list: list = None
    ) -> list[StorageProductUploadpicturesResponse]:
        """上传本地产品图片.
        ...
        resp = await self._post(
            ...
            {k: v for k, v in {"sku": sku, "picture_list": picture_list}.items() if v is not None},
        )
    ...
    async def attribute_list(self, offset: int = None, length: int = None) -> tuple[list[AttributeListItem], int]:
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/attribute/attributeList",
            {k: v for k, v in {"offset": offset, "length": length}.items() if v is not None},
        )
        return self._parse_page(resp.data, AttributeListItem)

    async def attribute_set(
        self, pa_id: int = None, attr_name: str = None, attr_values: list = None
    ) -> list[StorageAttributeSetResponse]:
        """添加 / 编辑产品属性.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/attribute/set",
            {
                k: v
                for k, v in {"pa_id": pa_id, "attr_name": attr_name, "attr_values": attr_values}.items()
                if v is not None
            },
        )
    ...
    async def batch_get_product_info(
        self, productIds: list = None, skus: list = None, sku_identifiers: list = None
    ) -> LocalInventoryBatchgetproductinfoResponse | None:
        """批量查询本地产品详情.
        ...
        resp = await self._post(
            ...
            {
                k: v
                for k, v in {"productIds": productIds, "skus": skus, "sku_identifiers": sku_identifiers}.items()
                if v is not None
            },
        )
        return self._parse_one(resp.data, LocalInventoryBatchgetproductinfoResponse)

    async def bundled_product_list(
        self, offset: int = None, length: int = None
    ) -> list[LocalInventoryBundledproductlistResponse]:
        """查询捆绑产品关系列表.
        ...
        Args:
            ...
            length: 分页长度，默认1000，上限1000, int."""
        resp = await self._post(
            "/erp/sc/routing/data/local_inventory/bundledProductList",
            {k: v for k, v in {"offset": offset, "length": length}.items() if v is not None},
        )
    ...
    async def get_transparency_product_list(
        self,
        isRelateMsku: int = None,
        length: int = None,
        offset: int = None,
        productStatus: str = None,
        searchField: str = None,
        searchValue: str = None,
    ) -> list[ProductGettransparencyproductlistResponse]:
        """产品管理-查询透明计划商品列表.
        ...
        resp = await self._post(
            "/basicOpen/product/getTransparencyProductList",
            {
                k: v
                for k, v in {
    ...
    async def product_aux_list(
        self, offset: int = None, length: int = None
    ) -> list[LocalInventoryProductauxlistResponse]:
        """查询产品辅料列表.
        ...
        Args:
            ...
            length: 分页长度，默认1000，上限1000, int."""
        resp = await self._post(
            "/erp/sc/routing/data/local_inventory/productAuxList",
            {k: v for k, v in {"offset": offset, "length": length}.items() if v is not None},
        )
        return self._parse_list(resp.data, LocalInventoryProductauxlistResponse)

    async def product_operate_batch(
        self, product_ids: list = None, batch_status: str = None
    ) -> ProductOperateBatchResponse | None:
        """产品启用、禁用.
        ...
        resp = await self._post(
            "/basicOpen/product/productManager/product/operate/batch",
            {k: v for k, v in {"product_ids": product_ids, "batch_status": batch_status}.items() if v is not None},
        )
    ...
    async def set_aux(
        ...
        product_name: str = None,
        cg_price: float = None,
        cg_product_length: float = None,
        cg_product_width: float = None,
        cg_product_height: float = None,
        cg_product_net_weight: float = None,
        remark: str = None,
        supplier_quote: list = None,
    ) -> list[StorageProductSetauxResponse]:
        """添加 / 编辑辅料.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/product/setAux",
            {
                k: v
                for k, v in {
                    "sku": sku,
    ...
    async def spu_info(self, ps_id: int = None, spu: str = None) -> list[StorageSpuInfoResponse]:
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/spu/info", {k: v for k, v in {"ps_id": ps_id, "spu": spu}.items() if v is not None}
        )
    ...
    async def spu_set(
        ...
        bid: int = None,
        create_uid: int = None,
        developer_uid: int = None,
        product_duty_uids: list = None,
        description: str = None,
        use_spu_template: int = None,
        sku_list: list = None,
        sku_lis: list = None,
        purchase_info: dict = None,
        logistics: dict = None,
        aux_relation_list: list = None,
        attribute_skc_list: list = None,
    ) -> list[StorageSpuSetResponse]:
        """添加/编辑多属性产品.
        ...
        resp = await self._post(
            "/erp/sc/routing/storage/spu/set",
            {
                ...
                for k, v in {
                    ...
                    "logistics": logistics,
                    "aux_relation_list": aux_relation_list,
                    "attribute_skc_list": attribute_skc_list,
                }.items()
                if v is not None
            },
        )
